...
foreach( $_POST[UpdateOrderNum] as $the_order_num ){	
	...
	if (strlen($the_order_num)==7)
	{
		...
		$queryStatus="INSERT INTO status_history (order_num, order_status, update_type, update_time,update_ip, access_id, update_ip2, provient_de, browser  ) 
										  VALUES($the_order_num,'Frame sent to KNR/Monture envoy� � KNR','Admin fast shipping page','$datecomplete','$ip',$acces_id, '$ip2', '$provient_de','$browser')";
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="send_frame_knr.php">
...
<form  method="post" name="update_status" id="update_status" action="send_frame_knr.php">
			<?php 
			if ($rptQuery!=""){
