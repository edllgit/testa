...
if($_POST[rpt_search]=="search orders"){
	$rptQuery="SELECT orders.order_num, orders.order_product_discount, orders.order_over_range_fee, orders.order_product_name, orders.order_quantity, orders.order_date_processed, orders.lab, labs.primary_key as lab_key, labs.lab_name, exclusive.collection, exclusive.product_name from orders
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="goto_date" id="goto_date" action="reports_exclusive.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Exclusive
            					Products </font><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial"> 
...
?>
					...
					<td align="left" nowrap ><select name="product_name" id="product_name" class="formField">
						<option value="all" selected class="formFieldBold">All Exclusive Products</option>
						<?php
	...
	while ($prodList=mysql_fetch_array($result)){
		if($collection!=$prodList[collection]){
			...
			print "<option value=\"$category\" class=\"formFieldBold\">All $prodList[collection]</option>";
			$collection=$prodList[collection];
		}
		print "<option value=\"$prodList[product_name]\">$prodList[product_name]</option>";
}
?>
					</select>
					</td>
...
if ($rptCount != 0){
	...
	print "<tr bgcolor=\"#555555\"><td><font color=\"white\">Total $rpt_name Sales for $currentLab</font></td><td align=\"right\"><font color=\"white\">$prodLabTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesLabTotal</font></td></tr>";//print final total
			$salesLineTotal=0;
			$prodLineTotal=0;
			$prodLabTotal=0;
			$salesLabTotal=0;
	...
	$grandSalesTotal=bcadd($grandSalesTotal, $salesLabTotal, 2);
	print "<tr bgcolor=\"#555555\"><td><font color=\"white\">Total $rpt_name Sales for $currentLab</font></td><td align=\"right\"><font color=\"white\">$prodLabTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesLabTotal</font></td></tr>";//print final total
	print "<tr bgcolor=\"#000000\"><td><font color=\"white\">Total $rpt_name Sales</font></td><td align=\"right\"><font color=\"white\">$grandProdTotal</font></td><td align=\"right\"><font color=\"white\">\$$grandSalesTotal</font></td></tr>";//print grand total
