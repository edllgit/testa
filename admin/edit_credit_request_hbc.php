...
$adresse = "credit_status_update_detail_hbc.php?mcred_memo_num=". $mcred_memo_num;
//Rediriger dans la page de detail du credit
header("Location:".$adresse);
		 
?>
<form id="redirect" action="edit_credit_request_hbc.php" method="post">
...
<body>
<form name="update_credit_request" id="update_credit_request" method="post" action="edit_credit_request_hbc.php">
