  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="shipping_hbc.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">HBC Fast Shipping Tool</font></b></td>
            	</tr>
...
<form  method="post" name="update_status" id="update_status" action="shipping_hbc.php">
			<?php 
			if ($rptQuery!=""){
...
while ($listItem=mysqli_fetch_array($rptResult,MYSQLI_ASSOC)){
			...
			$order_date=$listItem[order_date_shipped];
			$ship_date=$listItem[order_date_shipped];
				...
				switch($listItem["order_status"]){
						...
						case 'in edging':				$list_order_status = "In Edging Swiss";				break;
						case 'in edging swiss':			$list_order_status = "In Edging";					break;
					...
					default: $list_order_status = "UNKNOWN STATUS";		break;
				}
		  ...
		  $DataMonture=mysqli_fetch_array($resultMonture,MYSQLI_ASSOC);
			...
			if (($list_order_status=='Shipped') || ($list_order_status=='Cancelled')){
				  ...
				  <td  bgcolor=\"#FF0000\" style=\"font-size:16px;\"  align=\"center\">$listItem[shape_name_bk]</td>";
			}else{
			$OrderAbleToUpdate +=1;
			 echo "
		...
		<td style=\"font-size:16px;\"  align=\"center\">$listItem[shape_name_bk]&nbsp;</td>";
			}
				...
				switch($listItem[prescript_lab]){
					...
					case 73: $PrescriptLab = 'KNR'; 			 break;
 ...
 if ($OrderAbleToUpdate > 0){
	...
	<td align=\"center\" colspan=\"13\" nowrap=\"nowrap\">
                   ...
                   <select style=\"font-size:14px;\" name=\"order_status\" id=\"order_status\" class=\"formField\">
					  ...
					  <option value=\"in edging swiss\">In Edging Swiss</option>
					  <option value=\"verifying\">Verification/Verifying</option>
					  <option value=\"scanned shape to swiss\">Scanned shape to Swiss</option>
					   <option value=\"waiting for frame store\">Attente de la monture Magasin/Waiting for Frame Store</option>
					    <option value=\"waiting for frame ho/supplier\">Attente de la monture Siege Social/Fournisseur/Waiting for Frame Head Office/Supplier</option>
 </select><br><br><br>";
