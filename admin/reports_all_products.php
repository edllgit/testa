...
<form  method="post" name="goto_date" id="goto_date" action="reports_all_products.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Product
...
if ($rptCount != 0){
	...
	print "<tr bgcolor=\"#555555\"><td><font color=\"white\">Total Product Sales for $currentLab</font></td><td align=\"right\"><font color=\"white\">$prodLabTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesLabTotal</font></td></tr>";//print final total
			$salesLineTotal=0;
			$prodLineTotal=0;
			$prodLabTotal=0;
			$salesLabTotal=0;
	...
	$grandSalesTotal=bcadd($grandSalesTotal, $salesLabTotal, 2);
	print "<tr bgcolor=\"#555555\"><td><font color=\"white\">Total Product Sales for $currentLab</font></td><td align=\"right\"><font color=\"white\">$prodLabTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesLabTotal</font></td></tr>";//print final total
	print "<tr bgcolor=\"#000000\"><td><font color=\"white\">Total Product Sales</font></td><td align=\"right\"><font color=\"white\">$grandProdTotal</font></td><td align=\"right\"><font color=\"white\">\$$grandSalesTotal</font></td></tr>";//print grand total
