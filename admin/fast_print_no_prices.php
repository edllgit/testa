...
foreach( $_POST[UpdateOrderNum] as $the_order_num ){	
	...
	window.open( "/admin/fastPrintnoprice.php?order_num=<?php echo $the_order_num?>" )
	</script>
...
<html>
<head> 
<title>Print STC orders without prices for Swisscoat</title>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="fast_print_no_prices.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Print <b>STC</b> Orders <u>without Prices</u> (for Swisscoat)</font></b></td>
            	</tr>
...
<form  method="post" name="update_status" id="update_status" action="fast_print_no_prices.php">
			<?php 
			if ($rptQuery!=""){
