  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="frame_sent_swiss.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Swiss Frames Tool</font></b></td>
            	</tr>
...
<form  method="post" name="update_status" id="update_status" action="frame_sent_swiss.php">
			<?php 
			if ($rptQuery!=""){
...
while ($listItem=mysql_fetch_array($rptResult)){
			...
			$ship_date=mysql_result($new_result,0,0);
				...
				switch($listItem["order_status"]){
						...
						case 'scanned shape to swiss':	$list_order_status = "Scannes shape to Swiss";		break;
		  ...
		  $resultMonture=mysql_query($queryMonture)		or die ('Could not insert because: ' . mysql_error());
		  $DataMonture=mysql_fetch_array($resultMonture);
 ...
 if ($OrderAbleToUpdate > 0){
	...
	<td align=\"center\" colspan=\"11\" nowrap=\"nowrap\">";
				  ...
				  if ($OrderAbleToUpdate > 0){
				  echo "<input name=\"update_status\" style=\"font-size:14px;\"  type=\"submit\" id=\"rpt_search\" value=\"Note these frames as sent to Swisscoat\" class=\"formField\"></tr>";
				  }else{
				  echo "<input name=\"update_status\" style=\"font-size:14px;\"  type=\"submit\" id=\"rpt_search\" disabled=\"disabled\" value=\"Note these frames as sent to Swisscoat\" class=\"formField\"></tr>";
				  }
