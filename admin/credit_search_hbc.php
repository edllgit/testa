  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="credit_search_hbc.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Credits Search</font></b></td>
            	</tr>
				...
				<tr bgcolor="#DDDDDD">
					<td align="center" valign="middle" nowrap bgcolor="#DDDDDD" >                        
                        <div style="font-size:14px;" align="center">You can search by order number <b>(Only One)</b></div>					
...
<form  method="post" name="update_status" id="update_status" action="credit_status_update_detail_hbc.php">
			<?php 
			if ($rptQuery!=""){
...
<tr bgcolor=\"#000000\"></tr>";
	  echo "<tr>
				...
				<td align=\"center\"><strong>Credit Status</strong></td>
...
while ($listItem=mysqli_fetch_array($rptResult,MYSQLI_ASSOC)){
			...
			//Commande déja shippé, on disable la case a cocher
				...
				$OrderAbleToUpdate +=1;
			 echo "<td style=\"font-size:16px;\"  align=\"center\"><a href=\"credit_status_update_detail_hbc.php?mcred_memo_num=". $listItem[mcred_memo_num]. "\">$listItem[order_num]</a></td> <td style=\"font-size:16px;\" align=\"center\">$order_date</td><td style=\"font-size:16px;\"  align=\"center\">$listItem[lab_name]</td><td style=\"font-size:16px;\"  align=\"center\">$listItem[company]</td><td   style=\"font-size:16px;\"  align=\"center\">$listItem[tray_num]&nbsp;</td><td  style=\"font-size:16px;\"  align=\"center\">$listItem[order_patient_first]&nbsp;</td><td  style=\"font-size:16px;\"  align=\"center\">$listItem[order_patient_last]&nbsp;</td><td style=\"font-size:16px;\"  align=\"center\">$listItem[patient_ref_num]&nbsp;</td>";
			//}
		...
		<td style=\"font-size:16px;\"  align=\"center\">$listItem[mcred_approbation]&nbsp;</td>";
		//}
		
		
		$queryAlreadyCredited  = "SELECT mcred_abs_amount as dejacredite FROM memo_credits WHERE mcred_memo_num = '$listItem[mcred_memo_num]'";
		$resultAlreadyCredited = mysqli_query($con,$queryAlreadyCredited)		or die ('Could not check already credited because: '. $queryAlreadyCredited .'<br>' .  mysqli_error($con));
...
<br><br> <div style="font-size:14px;" align="center">OR Select a pending credit from this dropdown:<br />

<form action="credit_status_update_detail.php" method="post" name="form2" id="form2">
    <select name="mcred_order_num" >
        <option value="" selected="selected">Select a credit</option>
        <?php
            $query="SELECT mcred_order_num, mcred_memo_num,   mcred_acct_user_id  from memo_credits_temp WHERE  mcred_approbation NOT IN ( 'refuse','refused','approved','approve')    order by mcred_order_num";
           echo '<br>'.$query;
    ...
    <input type="submit" name="Submit" value="View credit details" class="formField" /><br />
</form>
</div> 
