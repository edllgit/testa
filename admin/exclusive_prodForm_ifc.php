...
<link href="admin.css" rel="stylesheet" type="text/css" />
  ...
  <form name="form4" method="post" action="update_exclusive_product_ifc.php"  enctype="multipart/form-data">
...
<select name="real_manufacturer" class="formText" id="real_manufacturer">
    ...
    <option value="Crystal"<?php if ($productData[real_manufacturer]=='Crystal') echo ' selected=selected';  ?>>Crystal</option>
 ...
 echo "$name</option>";}?>
      ...
      <tr bgcolor="#DDDDDD">
        ...
        <td colspan="3" align="left" bgcolor="#FFFFFF"><select name="add_max" class="formText" id="add_max">
		  ...
		  <option value="5.00"<?php if($productData[add_max]=='5.00') echo " selected"; ?>>+5.00</option>
		  <option value="4.75"<?php if($productData[add_max]=='4.75') echo " selected"; ?>>+4.75</option>	
		  <option value="4.50"<?php if($productData[add_max]=='4.50') echo " selected"; ?>>+4.50</option>
		  <option value="4.25"<?php if($productData[add_max]=='4.25') echo " selected"; ?>>+4.25</option>	
