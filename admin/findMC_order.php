		...
		?></td>
  		...
  		<td width="75%"><form name="form3" method="post" action="createMemoCredit.php">
            <table border="0" cellpadding="2" cellspacing="0" class="formField" width="100%">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="6"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial"><?php echo 'ADMIN MEMO CREDIT ORDER SEARCH';?></font></b></td>
            		</tr>
				...
				<tr bgcolor="#DDDDDD">
					...
					<td align="left"><div align="right">
						<?php echo 'Patient Reference Number ';?></div></td>
					<td align="left"><input name="patient_ref_num" type="text" id="patient_ref_num" size="24"></td>
				</tr>
				<tr bgcolor="#DDDDDD">
					<td colspan="4" align="center"><input type="submit" name="submit" value="<?php echo 'search orders';?>" class="formField"><input type="hidden" name="searchOrders" value="Search Orders" class="formField"></td>
				</tr></table>
  		</form>
</td>
	  </tr>
