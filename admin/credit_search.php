  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="credit_search.php">
...
<form  method="post" name="update_status" id="update_status" action="credit_status_update_detail.php">
			<?php 
			if ($rptQuery!=""){
