...
<form name="form1" method="post" action="login.php" onSubmit="return formCheck(this);">
  <p>&nbsp;</p>
  <table width="700" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr bgcolor="#DDDDDD"> 
      <td width="202" align="right"> <p><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $lbl_logintxt_adm;?></font></p></td>
      <td width="604" align="left"> <input name="username_test" type="text" id="username_test" size="40"></td>
    </tr>
    <tr> 
      <td align="right"> <p><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $lbl_pwdtxt_adm;?></font></p></td>
