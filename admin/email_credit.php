...
if (($_POST["email_cred_btn"]=="Email Credit to Customer") && (strlen($_POST["memo_credit_number"]) ==9)){
//Envoyer par email le credit au client	
$leOrderNumber = substr($_POST["memo_credit_number"],1,7);
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="email_credit.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Email Credit to Customer</font></b></td>
            	</tr>
...
<form  method="post" name="email_credit" id="email_credit" action="email_credit.php">
			<?php 
			if ($rptQuery!=""){
