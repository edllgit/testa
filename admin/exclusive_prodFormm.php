...
<link href="admin.css" rel="stylesheet" type="text/css" />
  ...
  <form name="form4" method="post" action="update_exclusive_productm.php"  enctype="multipart/form-data">
...
<option  <?php if ($lenscatego == '') echo 'selected'; ?> value="">None</option>
        ...
        <td align="left" valign="middle" nowrap="nowrap" bgcolor="#FFFFFF"><font size="1" face="Arial, Helvetica, sans-serif">Active:</font>
            <input name="prod_status" type="checkbox" id="prod_status" value="active" <?php if ($productData[prod_status]=="active"){print "checked=\"checked\"";} ?>/>
            <br />
            <font size="1" face="Arial, Helvetica, sans-serif">Price Checked:</font>
           
           <?php if ($productData[price_checked]=="yes"){print "Yes";}
		   else{ ?>
            <input name="price_checked" type="checkbox" id="prod_status" value="yes" />
            <?php } ?>
      ...
      <tr bgcolor="#DDDDDD">
        <td colspan="6" align="right" valign="middle" nowrap="nowrap" bgcolor="#FFE5E5"><div align="center">
      ...
      <tr bgcolor="#DDDDDD">
        ...
        <td align="right"><font size="1" face="Arial, Helvetica, sans-serif"><b>E-Lab Price
          USA:</b></font></td>
 ...
 print "$name</option>";}?>
      ...
      <tr bgcolor="#DDDDDD">
        ...
        <td align="left" bgcolor="#FFFFFF"><font size="1">$
            ...
            <td align="right" bgcolor="#FFFFFF"><font size="1" face="Arial, Helvetica, sans-serif"><b>E-Lab Price
              Canada:</b></font></td>
        <td align="left" bgcolor="#FFFFFF"><font size="1">$
