...
if ($_SESSION[adminData][username]==""){
	...
	if($_GET[sort_by]!=""){
		$query="select * from ifc_ca_exclusive where prod_status='active' and (collection  like '%Entrepot%' OR collection like '%nurbs%') order by ".$_GET[sort_by];
		$_GET[sort_by]="";
	}else{
		$query="select * from ifc_ca_exclusive where prod_status='active' and (collection  like '%Entrepot%' OR collection like '%nurbs%')  order by collection, product_name";
	}
...
?>
		   ...
		   <table width="100%" border="0" cellpadding="2" cellspacing="0">
            	<tr bgcolor="#000000">
            		<td colspan="14" align="center"><b><font color="#FFFFFF" size="2" face="Helvetica, sans-serif, Arial">IFCCLUB.CA EXCLUSIVES PRODUCTS</font></b></td>
       		  </tr></table>
