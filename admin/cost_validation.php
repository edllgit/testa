...
if($_POST[rpt_search]=="Verifier/Verify")
{
	...
	$Array_OrderNum = array_filter(array_map('trim', $Array_OrderNum));
		...
		$valueSansEspace = trim($value, " ");
			...
			WHERE orders.order_num IN ($_POST[order_num]) AND lab IN (66,67)";
			//echo '<br><br>'. $rptQuery;
			}else{
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="cost_validation.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">EDLL Cost validation tool</font></b></td>
            	</tr>
...
<form  method="post" name="update_status" id="update_status" action="cost_validation.php">
			<?php 
			if ($rptQuery!=""){
...
<tr bgcolor=\"#000000\"></tr>";
	  echo "<tr>
				...
				<th align=\"center\"><strong>Cost (US)</strong></th>
	            </tr>
				<tr>";		  
$OrderAbleToUpdate = 0;
while ($listItem=mysql_fetch_array($rptResult)){
		...
		$resultProduct = mysql_query($queryProduct)		or die ('Could not insert because: ' . mysql_error());
		...
		<td style=\"font-size:16px;\" align=\"center\">$DataProduct[product_code]</td>
		<td style=\"font-size:16px;\" align=\"center\">$DataProduct[product_name]</td>
		<td style=\"font-size:16px;\" align=\"center\">$DataProduct[cost_us]</td>
		</tr>";
