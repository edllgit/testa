  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="shipping.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Outil d'exp&eacute;dition rapide/Fast Shipping Tool</font></b></td>
            	</tr>
...
while ($listItem=mysqli_fetch_array($rptResult,MYSQLI_ASSOC)){
			...
			$ship_date=$listItem[order_date_shipped];
				...
				switch($listItem["order_status"]){
						...
						case 'waiting for frame ho/supplier':	$list_order_status = "Waiting for Frame HO/Supplier";		break;
 ...
 if ($OrderAbleToUpdate > 0){
	...
	<td align=\"center\" colspan=\"13\" nowrap=\"nowrap\">
                   ...
                   <select style=\"font-size:14px;\" name=\"order_status\" id=\"order_status\" class=\"formField\">
					  ...
					  <option value=\"in edging swiss\">Au Taillage Swiss/In Edging Swiss</option>
