...
if($_POST[rpt_search]=="Verify")
{
	...
	//Valider les num�ros de commandes pass�, longeur doit etre de 5, doit etre numeric
	$errorMessage = '';
	$PassValidation = true;
	$Array_OrderNum = array_filter(array_map('trim', $Array_OrderNum));
		...
		$valueSansEspace = trim($value, " ");
			...
			//Si la longeur est >5 et qu'il n'y a pas de virgule, l'usager ne sait surement pas qu'il doit entrer des virgule entre chaque num�ro
...
foreach( $_POST[UpdateOrderNum] as $the_order_num ){	
	...
	window.open( "/admin/fastPrintHbcNoPrice.php?order_num=<?php echo $the_order_num?>" )
	</script>
...
<html>
<head> 
<title>Print HBC orders without prices (for Swisscoat)</title>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="verification" id="verification" action="fast_print_no_prices_hbc.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Print <b>HBC</b> Orders <u>without Prices</u> (for Swisscoat)</font></b></td>
            	</tr>
...
<form  method="post" name="update_status" id="update_status" action="fast_print_no_prices_hbc.php">
			<?php 
			if ($rptQuery!=""){
...
while ($listItem=mysqli_fetch_array($rptResult,MYSQLI_ASSOC)){
 ...
 if ($OrderAbleToUpdate > 0){
	...
	<td align=\"center\" colspan=\"11\" nowrap=\"nowrap\">";
				  ...
				  if ($OrderAbleToUpdate > 0){
				  echo "<input name=\"update_status\" style=\"font-size:14px;\"  type=\"submit\" id=\"rpt_search\" value=\"Save and Print checked orders without prices\" class=\"formField\"></tr>";
				  }else{
				  echo "<input name=\"update_status\" style=\"font-size:14px;\"  type=\"submit\" id=\"rpt_search\" disabled=\"disabled\" value=\"Save and Print checked orders without prices\" class=\"formField\"></tr>";
				  }
