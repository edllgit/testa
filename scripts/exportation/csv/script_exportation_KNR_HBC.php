...
$filename   = "KNR_OrderData2-".$today.".csv";
...
while ($orderData=mysqli_fetch_array($orderResult,MYSQLI_ASSOC)){
	$outputstring=export_order_KNR_HBC($orderData[order_num]);
...
$file        = "KNR_OrderData2-".$today.".csv";
$remote_file = "KNR_OrderData2-".$today.".csv";
