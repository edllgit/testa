...
AND  order_status like '%Courbure de base: En attente de redirection. Base Curve: waiting to be redirected%'";
...
if ($CountResultatTrouver==0)//La commande n'a jamais  été redirigé vers le lab #71, on le fait.
{
	...
	$order_status = "Courbure de base: En attente de redirection. Base Curve: waiting to be redirected";
	...
	$resultHistorique  = mysqli_query($con,$queryHistorique) or die  ('I cannot select items because: ' . mysqli_error($con));
		...
		$subject="Redirection Courbure de base";
