...
if ($oldest_file <> ''){
	...
	$local_file='Fichier_Temporaire_MAJ_Status_GKB_HBC443253.csv';
	...
	$row = 1;
	$handle = fopen("Fichier_Temporaire_MAJ_Status_GKB_HBC443253.csv", "r");
	$count=0;
		...
		if ($listItem[order_num]==$CSV_Order_Num){
			...
			echo  ' Existe deja (0 = non, 1=oui):' . $ExisteDeja. '<br>';
				...
				if ($ExisteDeja == 0) {
					...
					$queryStatusHistory="INSERT INTO status_history (order_status, order_num, update_time,update_type)VALUES ('$file_order_status','$CSV_Order_Num', '$datecomplete','gupdate script 2.0')";
