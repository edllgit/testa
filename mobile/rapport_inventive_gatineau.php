...
<table width='$WidthTableau' border=\"1\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\" class=\"formField\">
	<tr>
		<th  colspan=\"$LargeurColspanTableau\"><h3>Rapport Incitatifs EDLL $date1-$date2 </h3></th>
	</tr>";
...
$StoreDescription	= "EDLL Gatineau";
...
$subject ="Rapport Global Incitatif Gatineau pour la période [$date1-$date2]";

//$Report_Email	= array('dbeaulieu@direct-lens.com','dbeaulieu@direct-lens.com','dbeaulieu@direct-lens.com','gbruneau@entrepotdelalunette.com');//LIVE	
	...
	*/
	...
	$message.= "
		<tr>
			...
			<th bgcolor=\"#B15E6C\" align=\"center\">GTC</th>
	...
	WHERE order_date_processed BETWEEN '$date1' AND '$date2' 	AND user_id in ('gatineau','gatineausafe')
	...
	//Ajouter bonus si le % de reprises est inférieur a 5%, bonus de 200$ au magasin
	if ($PourcentageReprise<5.01){
		$SommedesBonusMagasinActuel = $SommedesBonusMagasinActuel+200;
	}//END IF
