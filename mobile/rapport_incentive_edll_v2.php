...
for ($i = 1; $i <= 20 ; $i++) {
		...
		switch($i){
			...
			case  2: 
			//include('../sec_connectEDLL.inc.php');
			$Userid =  " ('levis')";    		$Partie = 'Levis';			$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  3:  
			//include('../sec_connectEDLL.inc.php');	
			$Userid =  " ('entrepotquebec')"; $Partie = 'Quebec';			$send_to_address = array('rapports@direct-lens.com');break;
			...
			case  7:  
			//include('../sec_connectEDLL.inc.php');
			$Userid =  " ('entrepotifc')";    $Partie = 'Trois-Rivieres';	$send_to_address = array('rapports@direct-lens.com');break;
		
			case  8: 
			//include_once('../connexion_hbc.inc.php');
			$Userid =  "('88666')";    		$Partie = 'Griffe Trois-Rivieres';	$send_to_address = array('rapports@direct-lens.com');
			break;
			...
			case  12: 
			//include('../sec_connectEDLL.inc.php');
			$Userid =  " ('stjerome')";    	$Partie = 'Saint-Jerome';	$send_to_address = array('rapports@direct-lens.com');break;
...
<table width='$WidthTableau' border=\"1\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\" class=\"formField\">
	...
	$subject ="Rapport Incentive EDLL FF $Partie pour la periode [$date1-$date2]";
	$Report_Email= array('dbeaulieu@direct-lens.com','gbruneau@entrepotdelalunette.com','lbouthillier@entrepotdelalunette.com','rapports@direct-lens.com','pcharenton@entrepotdelalunette.com');//LIVE
	//$Report_Email	= array('rapports@direct-lens.com');//LIVE
...
function CalculerIncentiveEDLL($Userid_Magasin,$Description_Magasin,$date1,$date2){
	...
	*/
	...
	$message.= "
		<tr>
			<th align=\"center\">Employ&eacute</th>
