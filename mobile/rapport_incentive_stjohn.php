...
<table width='$WidthTableau' border=\"1\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\" class=\"formField\">
	<tr>
		<th  colspan=\"$LargeurColspanTableau\"><h3>Rapport Incitatifs St-John $date1-$date2 </h3></th>
	</tr>";
	
	$message.= "<tr valign=\"middle\"><th bgcolor=\"#EFE9E7\" colspan=\"$LargeurColspanTableau\"><h3>Succursale:Saint-John</h3></th></tr>";
	$message.= "
		<tr>
	...
	AND salesperson_id<>''	AND user_id IN ('stjohn','stjohnsafe')
	...
	WHERE order_date_processed BETWEEN '$date1' AND '$date2' 	AND user_id in ('stjohn','stjohnsafe')
   ...
   $message.= "<tr>
			<th bgcolor=\"#EFE9AE\" colspan=\"1\" align=\"right\">TOTAL POUR ST-John :</th>
...
//Copie Admin
$response=office365_mail($to_address, $from_address, 'Rapport Incentive Saint-John Copie Admin', null, $message_Admin);
