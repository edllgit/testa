...
class Google2FATest extends TestCase
{
    ...
    {
        $this->assertEquals(Constants::URL, $this->google2fa->setAllowInsecureCallToGoogleApis(true)->getQRCodeGoogleUrl('PragmaRX', 'acr+dbeaulieu@direct-lens.com', Constants::SECRET));
    }
    ...
    {
        $this->assertEquals(Constants::URL, $this->google2fa->getQRCodeGoogleUrl('PragmaRX', 'acr+dbeaulieu@direct-lens.com', Constants::SECRET));
    }
    ...
    public function testQrcodeInline()
    {
        $this->assertEquals(
            ...
            $this->google2fa->getQRCodeInline('PragmaRX', 'acr+dbeaulieu@direct-lens.com', Constants::SECRET)
        );
    }
}
