...
$today     = date("Y-m-d");
//$today     = "2015-11-16";
$rptQuery  = "SELECT * FROM orders  WHERE lab IN (66,67) AND prescript_lab = 10 AND frame_sent_swiss <> '0000-00-00 00:00:00'  AND orders.frame_sent_swiss like  '%$today%'";
//echo $rptQuery;
...
$ordersnum = mysqli_num_rows($rptResult);
	...
	$barcode="http://cf.direct-lens.com/labAdmin/".$SwissEdgingBarcode.".gif";
