...
$subject="Sommaire Special Instructions du :". $hier;
...
//Log email
	...
	if($response){ 
		log_email("REPORT: Special Instructions",$EmailEnvoyerA,"SENT",$_SERVER['HTTP_USER_AGENT']);
    }else{
		log_email("REPORT: Special Instructions",$EmailEnvoyerA,"FAILED",$_SERVER['HTTP_USER_AGENT']);
	}	
