...
$subject="Drummondville Rapport d'inventaire des montures";	
...
//Log email
	...
	if($response){ 
		log_email("REPORT: Frames inventory Drummondville",$EmailEnvoyerA,"SENT",$_SERVER['HTTP_USER_AGENT']);
    }else{
		log_email("REPORT: Frames inventory Drummondville",$EmailEnvoyerA,"FAILED",$_SERVER['HTTP_USER_AGENT']);
	}	
