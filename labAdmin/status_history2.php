...
$HistoryResult=mysql_query($queryHistory)	or die  ('I cannot select items because 1: ' . mysql_error());
		...
		if ($HistoryData['access_id']  <> '' ){
			...
			$ResultAccess=mysql_query($QueryAccess)	or die  ('I cannot select items because 2: ' . mysql_error());
		...
		if (($mylang == 'lang_France') || ($mylang == 'lang_french'))  {
			...
			case 'central lab marking':	$status_to_print = "Central Lab Marking";			break;
			case 'in mounting hko':		$status_to_print = "Au Montage HKO";				break;
			case 'in edging':			$status_to_print = "Au Taillage";					break;
			case 'in edging hko':		$status_to_print = "Au Taillage HKO";				break;
			case 'order imported':		$status_to_print = "Commande en cours";				break;
			case 'information in hand':	$status_to_print = "Info Transmise";   				break;
			case 'interlab vot':	    $status_to_print = "Interlab P";   					break;
			case 'interlab qc':	    	$status_to_print = "Interlab QC";   				break;
			...
			case 'waiting for frame swiss':	$status_to_print = "Attente de monture Swiss";			break;
			case 'waiting for frame hko':$status_to_print = "Attente de monture HKO";		break;
			...
			case 'verifying':			$status_to_print = "Inspection";					break;		
			...
			default:					$status_to_print= $HistoryData['order_status'];		break;
				...
				switch($HistoryData['order_status']){
					...
					case "profilo":						$status_to_print = "Profilo";					break;
					case "in mounting":					$status_to_print = "In Mounting";				break;
					case 'in mounting hko':				$status_to_print = "In Mounting HKO";			break;
					case "in edging":					$status_to_print = "In Edging";					break;
					case 'in edging hko':				$status_to_print = "In Edging HKO";				break;
					...
					case 'waiting for frame hko':	    $status_to_print = "Waiting for Frame HKO";		break;
					case "waiting for shape":			$status_to_print = "Waiting for Shape";			break;
					case "information in hand":			$status_to_print = "Info in Hand";			    break;
					...
					case "interlab":					$status_to_print = "Interlab P";				break;
					case "interlab qc":					$status_to_print = "Interlab P";				break;
					case "filled":						$status_to_print = "Shipped";					break;
					case "waiting for lens":			$status_to_print = "Waiting for Lens";			break;
					case "verifying":					$status_to_print = "Verifying";					break;
					default:							$status_to_print = $HistoryData['order_status'];break;
				}
			}
