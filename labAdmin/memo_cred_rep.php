...
<body>
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
   ...
   <?php    
 if ($mylang == 'lang_french'){
		echo '<br><br><p align="center"><a style="text-decoration:none;" href="reports_memo_cred_details.php">Rapport détaillé de l\'utilisation des mémo-crédits</a><br><br><a style="text-decoration:none;" href="reports_memo_cred.php">Rapport résumé de l\'utilisation des mémo-crédits</a></p>';
 }else {
