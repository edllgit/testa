...
switch($store){
	case 'chicoutimi':     $userID = "('chicoutimi','chicoutimisafe')"; 		break;
	...
	case 'gatineau':   	   $userID = "('gatineau','gatineausafe')";  			break;
	case 'stjerome':   	   $userID = "('stjerome','stjeromesafe')";  			break;
}
