...
<form  method="post" name="goto_date" id="goto_date" action="printBulkStmts_test.php" target="_blank">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="form-text-large">
            	<tr bgcolor="#000000">
				...
				<tr bgcolor="#DDDDDD">
					<td colspan="2" align="center"><?php echo $adm_datefr_txt; ?>

					  <input name="date_from" type="text" class="form-text-large" id="date_from" value="<?php echo $firstDay; ?>" size="11">
					  <A HREF="#" onClick="cal1xx.select(document.goto_date.date_from,'anchor1xx','MM/dd/yyyy'); return false;" TITLE="Popup calendar for quick date selection" NAME="anchor1xx" ID="anchor1xx"><img src="../includes/popup_cal.gif" width="14" height="14" hspace="2" border="0" align="absmiddle"></A>&nbsp;&nbsp;&nbsp;<?php echo $adm_through_txt; ?>&nbsp;&nbsp;&nbsp;<input name="date_to" type="text" class="form-text-large" id="date_to" value="<?php echo $lastDay; ?>" size="11">
					...
					?>
					<td width="10%"><select name="stmt_month" id="stmt_month" class="form-text-large">
					...
					<td><select name="stmt_year" id="stmt_year" class="form-text-large">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="30%" align="left" nowrap><input name="stmt_type" type="radio" value="individual" class="form-text-large" checked="checked"><?php echo $adm_selacctbelow_txt; ?></td>
					<td align="left" nowrap><input name="stmt_type" type="radio" value="bulk" class="form-text-large"><?php echo $adm_selbulk_txt; ?></td>
					<td colspan="2" align="left" nowrap>&nbsp;</td>
					</tr>
				<tr bgcolor="#DDDDDD">
					<td nowrap><div align="right">
						<?php echo $adm_selsort_txt; ?></div></td>
					<td align="left" nowrap><select name="acct_user_id" id="acct_user_id" class="form-text-large">
...
?>
					...
					<td align="left" nowrap><input name="stmt_sort" type="radio" value="account" class="form-text-large" checked="checked"><?php echo $adm_acct_txt; ?>&nbsp;&nbsp;
<input name="stmt_sort" type="radio" value="buying group" class="form-text-large"><?php echo $adm_buygrp_txt; ?></td>
					<td colspan="2" align="left" nowrap>&nbsp;</td>
					</tr>
				<tr>
					<td colspan="5"><div align="center"><input name="submit" type="submit" id="submit" value="<?php echo $btn_preparestate_txt; ?>" class="form-text-large"><input name="stmt_search" type="hidden" id="stmt_search" value="prepare statements"></div></td>
					</tr>
			</table>
</form>
</td>
