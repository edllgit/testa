...
<?php
	...
	$query="Update labs set   other_lab='3' where primary_key = '21'";
	$result=mysql_query($query)		or die ("Un probleme est survenu");
	echo' Maintenant redirigé a ST-CAT';


echo '<br><br><a href="redirection_drummond_email.php">Envoyer la liste des commande redirigés</a>';
