...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        alert("Le formulaire a été mis à jour avec succès.");
...
<form action="re-doEditV3.php" method="post" name="redoForm" id="redoForm" onSubmit="return checkProduct(this)">			
 ...
 // echo 	'<br> Charles: '. $queryPkClient. '<br>';  
                            ...
                            while ($DataRedoReason=mysqli_fetch_array($resultRedo,MYSQLI_ASSOC)){
                                ...
                                if ($listItem[redo_reason_id]== $DataRedoReason[redo_reason_id])
                                    ...
                                    if ($mylang == 'lang_french'){
                                        ...
                                        //echo "$name&nbsp;($DataRedoReason[rebate_percentage]) DÉTAIL: $DataRedoReason[explication_succursale] ($DataRedoReason[Pourcentage_a_emettre_comme_credit])</option>";
                                        echo "$name&nbsp;[$DataRedoReason[explication_succursale]] ($DataRedoReason[Pourcentage_a_emettre_comme_credit])</option>";
                                }else {
 ...
 <tr>         
    ...
    <b><?php if($mylang == 'lang_french'){echo "Couleur";}else{echo "Color";}?></b>:<input type="text" name="color" id="color" size="15" value="<?php echo $frameItem[color];?>" />&nbsp;&nbsp;&nbsp;		 
        ...
        <?php
             ...
             <tr><td colspan="10">&nbsp;</td></tr>	 
              ...
              <tr>
                   ...
                   <?php  //   <input name="Submitbtn" type="submit" id="Submitbtn" class="formField3" value="Update" onclick="this.form.submit()" > ?>
						<!--input name="Submitbtn" type="submit" id="Submitbtn" class="formField3" value="Update" onclick="this.form.submit()"-->
						<input name="Submitbtn" type="submit" id="Submitbtn" class="formField3" value="Update" onclick="submitForm()">
			...
			<form method="post" enctype="multipart/form-data" action="upload.php" name="formShape" id="formShape">
				<!-- Votre code ici... -->
            ...
            ?>
				...
				<tr>
					<td align="left">&nbsp;
						<input type="file" name="file" id="file" onclick="btnupload.disabled=false;btnupload.value='Upload'"  size="40" required>&nbsp;
					</td>
					<td align="left" colspan="7">&nbsp;
						...
						<input type="hidden" name="order_num" id="order_num" value="<?php echo $listItem['order_num'] ?>">
						 <input name="pkey" type="hidden" id="pkey" value="<?php echo $pkey;?>"></td>
					</td>
				</tr>
