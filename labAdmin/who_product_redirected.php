...
<body>
<form  method="post" name="Who_product_redirected1" id="Who_product_redirected1" action="who_product_redirected.php">
...
<form  method="post" name="Who_product_redirected2" id="Who_product_redirected2" action="who_product_redirected.php">
...
<form  method="post" name="Who_product_redirected3" id="Who_product_redirected3" action="who_product_redirected.php">
<tr align="center" bgcolor="#DDDDDD">
<td nowrap="nowrap">
...
Polarized:
 ...
 <option value="Select a color">Select a color</option>
	<?php
    $query      = "SELECT polar FROM ifc_ca_exclusive WHERE collection like '%entrepot%'  GROUP BY polar asc"; /* select all openings */
...
Transitions:
 ...
 <option value="Select a color">Select a color</option>
	<?php
    $query      = "SELECT photo FROM ifc_ca_exclusive WHERE collection like '%entrepot%'  GROUP BY photo asc"; /* select all openings */
    $result     = mysqli_query($con,$query) or die ("Could not select items");
    $usercount  = mysqli_num_rows($result);
...
Lens Category:
 ...
 <option value="All">All</option>
	<?php
    $query      = "SELECT lens_category FROM ifc_ca_exclusive WHERE collection like '%entrepot%'  GROUP BY lens_category"; /* select all openings */
    $result     = mysqli_query($con,$query) or die ("Could not select items");
    $usercount  = mysqli_num_rows($result);
