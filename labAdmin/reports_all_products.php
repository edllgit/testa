  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<form  method="post" name="goto_date" id="goto_date" action="reports_all_products.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial"><?php echo $adm_productsales_txt; ?></font></b></td>
            		</tr>
				<tr bgcolor="#DDDDDD">
					...
					<td width="15%"><div align="center">
						<?php echo $adm_through_txt; ?></div></td>
...
if ($rptCount != 0){
	...
	echo "<tr bgcolor=\"#555555\"><td><font color=\"white\">".$adm_totprodsalesfor_txt." $currentAcct</font></td><td align=\"right\"><font color=\"white\">$prodAcctTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesAcctTotal</font></td></tr>";//print final total
			$salesLineTotal=0;
			$prodLineTotal=0;
			$prodAcctTotal=0;
			$salesAcctTotal=0;
	...
	$grandSalesTotal=bcadd($grandSalesTotal, $salesAcctTotal, 2);
	echo "<tr bgcolor=\"#555555\"><td><font color=\"white\">".$adm_totprodsalesfor_txt." $currentAcct</font></td><td align=\"right\"><font color=\"white\">$prodAcctTotal</font></td><td align=\"right\"><font color=\"white\">\$$salesAcctTotal</font></td></tr>";//print final total
	echo "<tr bgcolor=\"#000000\"><td><font color=\"white\">".$adm_totprodsales_txt."</font></td><td align=\"right\"><font color=\"white\">$grandProdTotal</font></td><td align=\"right\"><font color=\"white\">\$$grandSalesTotal</font></td></tr>";//print grand total
	echo "<tr><td colspan='3' align='right'><a  onclick='document.getElementById(\"goto_date\").target = \"_blank\"; document.getElementById(\"goto_date\").action = \"reports_all_products_print.php\"; document.getElementById(\"goto_date\").submit(); return false;'>".$adm_print_txt."</a></td></tr>";//print grand total
