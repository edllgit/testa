...
$subject="Saint-Catharines Rapport d'inventaire des montures";	
...
//Log email
	...
	if($response){ 
		log_email("REPORT: Frames inventory Saint-Catharines",$EmailEnvoyerA,"SENT",$_SERVER['HTTP_USER_AGENT']);
    }else{
		log_email("REPORT: Frames inventory Saint-Catharines",$EmailEnvoyerA,"FAILED",$_SERVER['HTTP_USER_AGENT']);
	}	
