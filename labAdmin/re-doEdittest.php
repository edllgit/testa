 ...
 ?>
                ...
                <tr >
                  <td colspan="8" bgcolor="#555555"><font color="#FFFFFF">Product
                      - <?php
                    $prodQuery="SELECT * FROM exclusive WHERE prod_status='active'   order by primary_key"; /* select all openings */
                ...
                <tr >
                  ...
                  <td align="center" bgcolor="#DDDDDD"><input name="re_axis" type="text" class="formField2" id="re_axis" value="<?php echo $listItem[re_axis];?>" size="4" maxlength="4"></td>
  ...
  <input name="RE_PR_IO" type="radio" value="Out"<?php if ($listItem[re_pr_io]=='Out') echo 'checked="checked"';?> />
                    ...
                    None
&nbsp;&nbsp;<input name="re_pr_ax" type="text" class="formField2" id="re_pr_ax" value="<?php echo $listItem[re_pr_ax];?>" size="3" maxlength="3"><br><input name="RE_PR_UD" type="radio" value="Up" <?php if ($listItem[re_pr_ud]=='Up') echo 'checked="checked"';?>/>Up&nbsp;
...
None
<input name="re_pr_ax2" type="text" class="formField2" id="re_pr_ax2" value="<?php echo $listItem[re_pr_ax2];?>" size="3" maxlength="3"></td><td rowspan="7" align="center" valign="top" class="formCellNosidesCenter"><input name="order_quantity" type="text" class="formField2" id="order_quantity" value="<?php echo $listItem[order_quantity];?>" size="4" maxlength="4"></td>
                ...
                <tr >
                  <td colspan="6" align="left"><strong>Dist.
                    PD:
                      <input name="re_pd" type="text" class="formField2" id="re_pd" value="<?php echo $listItem[re_pd];?>" size="4" maxlength="4">
                  </strong>&nbsp;&nbsp;&nbsp;<strong>Near
                      PD:</strong>
                  <input name="re_pd_near" type="text" class="formField2" id="re_pd_near" value="<?php echo $listItem[re_pd_near];?>" size="4" maxlength="4">                  &nbsp;&nbsp;&nbsp;<strong>Height:</strong>
                  <input name="re_height" type="text" class="formField2" id="re_height" value="<?php echo $listItem[re_height];?>" size="4" maxlength="4"></td>
                </tr>
                <tr >
                  ...
                  <td align="center" bgcolor="#DDDDDD"><input name="le_axis" type="text" class="formField2" id="le_axis" value="<?php echo $listItem[le_axis];?>" size="4" maxlength="4"></td>
  ...
  <input name="LE_PR_IO" type="radio" value="Out" <?php if ($listItem[le_pr_io]=='Out') echo 'checked="checked"';?>/>
                    ...
                    None 
                  <input name="le_pr_ax" type="text" class="formField2" id="le_pr_ax" value="<?php echo $listItem[le_pr_ax];?>" size="3" maxlength="3"><br><input name="LE_PR_UD" type="radio" value="Up" <?php if ($listItem[le_pr_ud]=='Up') echo 'checked="checked"';?>/>Up&nbsp;<input name="LE_PR_UD" type="radio" value="Down" <?php if ($listItem[le_pr_ud]=='Down') echo 'checked="checked"';?>/>
                  Down 
                  <input name="LE_PR_UD" type="radio" value="None" <?php if ($listItem[le_pr_ud]=='None') echo 'checked="checked"';?>/>Down&nbsp; <input name="le_pr_ax2" type="text" class="formField2" id="le_pr_ax2" value="<?php echo $listItem[le_pr_ax2];?>" size="3" maxlength="3"></td></tr>
                <tr >
                  ...
                  <input name="le_height" type="text" class="formField2" id="le_height" value="<?php echo $listItem[le_height];?>" size="4" maxlength="4"></td>
                </tr>
                <tr >
