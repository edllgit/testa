...
//DÉMARRER LA SESSION
session_start();
$collectionIN = "('ER Crystal','ER CSC','ER HKO','ER STC','ER Swiss','ER Versano')";
...
if($_POST["rpt_search"]=="search by criterias"){
	...
	if ($_POST[coating] <> "All"){ 
		switch($_POST[coating]){
			case 'Xlr' : 		   $FilterCoating = " AND coating IN ('MaxiiVue','Xlr')";    break;
...
<body>
<form  method="post" name="Who_product_redirected1" id="Who_product_redirected1" action="who_product_redirected_er.php">
...
<form  method="post" name="Who_product_redirected2" id="Who_product_redirected2" action="who_product_redirected_er.php">
...
<form  method="post" name="Who_product_redirected3" id="Who_product_redirected3" action="who_product_redirected_er.php">
<tr align="center" bgcolor="#DDDDDD">
<td nowrap="nowrap">
Index:
...
<select name="coating" class="formField" id="coating">
    ...
    <option value="MaxiiVue">Xlr</option>
...
<form  method="post" name="Who_product_redirected3" id="Who_product_redirected3" action="who_product_redirected_er.php">
				<tr align="center" bgcolor="#FFFFFF">
                 ...
                 <?php /*?><select name="manufacturer" class="formField" id="manufacturer">
...
if (($usercount != 0) && ($_POST["rpt_search"] <> '')){//some products were found
	...
	switch($listItem[collection]){
        case 'ER Crystal': $Fabriquant = "TR";   break;
		case 'ER CSC':     $Fabriquant = "CSC";   break;
		case 'ER HKO':     $Fabriquant = "HKO/Central Lab";   break;
		case 'ER STC':     $Fabriquant = "STC/Dlab";   break;
		case 'ER Swiss':   $Fabriquant = "Swiss"; break;
		case 'ER Versano': $Fabriquant = "GKB/Essilor #1 Lab";   break;
