...
echo "Primary Key: ".$pkey;
echo "Order Num: ".$order_num;
echo "<br><br>";


echo 'New order num requested!';

$new_order_num=getNewOrderNum();

echo '<br>New order num that has been created:' .$new_order_num;
	...
	switch($key)
		{
			...
			case 'shape_copied_swiss_ftp':                      $query.=",''";                          break;
			case 'result_copy_ftp_swiss':                       $query.=",''";                          break;
...
header("Location:re-doEdit.php?pkey=$lastPkey");
