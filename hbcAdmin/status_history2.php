...
$HistoryResult=mysql_query($queryHistory)	or die  ('I cannot select items because 1: ' . mysql_error());
		...
		if (($mylang == 'lang_France') || ($mylang == 'lang_french'))  {
			...
			case 'waiting for frame store':	$status_to_print = "Attente de monture Store";			break;
			case 'waiting for frame ho/supplier':	$status_to_print = "Attente de monture Head Office/Supplier";			break;
