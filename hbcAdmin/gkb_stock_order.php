...
if ($IDaEffacer <> ''){
	...
	echo '<br>' . $queryDelete;
	$resultDelete  = mysql_query($queryDelete)		or die  ('I cannot select items because: <br><br>' . mysql_error());	
...
if ($_POST[add_to_order]=='Add to my GKB order'){
	...
	$resultvalide = mysql_query($queryValide)		or die  ('I cannot validate this: <br><br>' . mysql_error());
	$ExisteDeja   = mysql_num_rows($resultvalide);
		...
		$resultInsert = mysql_query($queryInsert)		or die  ('I cannot add to the gkb order <br><br>' . mysql_error());
		header("Location: gkb_stock_order.php");
		exit();
      ...
      <td align="center"><strong>Add to Order</strong></td>
       ...
       <td align="center" width="30%">
        <select name="product_name"  id="product_name">
            ...
            <option value="1.59 White 75mm with HC">1.59 White 75mm with HC</option>
            <option value="1.59 White 75mm with HMC">1.59 White 75mm with HMC</option>
             <option value="1.59 White 75mm with SHMC">1.59 White 75mm with SHMC</option>
            <option value="1.59 White 75mm with AQUA+">1.59 White 75mm with AQUA+</option> 
            <option value="" disabled></option>
...
echo $queryUpd . '<br>';
$rptUpd=mysql_query($queryUpd)		or die  ('I cannot select items because: <br><br>' . mysql_error());
$DataUpd=mysql_fetch_array($rptUpd);
mysql_free_result($rptUpd);	
