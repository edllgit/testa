...
if ($_POST[update_prescription]=="true"){
	...
	//Rediriger dans la page sommaire
//iciici ex http://b.direct-lens.com/hbcAdmin/display_order.php?order_num=54651&po_num=
//rediriger vers la page php qui fera fermer la fenetre
header("Location:display_order.php?order_num=$listItem[order_num]");
exit();
}
...
$prodQuery="SELECT * FROM ifc_ca_exclusive WHERE primary_key= (SELECT order_product_id FROM orders where primary_key=$pkey)"; //get product info
//echo $prodQuery;
