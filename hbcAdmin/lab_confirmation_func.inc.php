...
$bc->draw("$orderNum".".gif");
	...
	if ($listItem['product_line']=="hbc"){
		$dl_logo_file="nologo";
		$pl_text="HBC";
	}else{$dl_logo_file="https://".constant('AWS_S3_BUCKET').".s3.amazonaws.com/direct-lens/logos/lensnet_logo.gif";
		$pl_text="???";
	}
...
$query="SELECT * from orders WHERE user_id='$user_id' and order_num='$orderNum' and order_product_type='exclusive' ORDER by order_item_date";//SELECT ALL OPEN PRESCRIPTION ORDERS
         ...
         <tr >
              ...
              <tr >
			   ...
			   $resultEntryFee = mysqli_query($con,$queryEntryFee)	or die ("Could not select items  rr32");
			   ...
			   $resultWarranty = mysqli_query($con,$queryWarranty)	or die ("Could not select items gf365");
			 ...
			 $resultTopUrgent=mysqli_query($con,$queryTopUrgent)	or die ("Could not select items f553");
