...
function login_to_dl($user_test, $password_test){/* check user_id and password on login */
	...
	$query="select * from accounts where user_id = '$user_test' and password = '$password_test'";
...
function PrivilegeCustomerEmail($email){/* sends the emails */
	$message ="Un nouveau client a entré le code privilège pour la promo 500$. \r\n\r\n";
...
function IpadEmail($email){/* sends the emails */
	$message ="Un nouveau client a entré le code privilège pour la promo IPAD. \r\n\r\n";
	$headers = "From: info@direct-lens.com\r\n";
	$headers .=	"Content-Type: text/plain; charset=\"iso-8859-1\"\r\n";
