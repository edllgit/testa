  ...
  <table border="0" cellspacing="0" cellpadding="0" width="95%">
  	<tr valign="top">
		...
		?></td>
  		...
  		<td width="1" bgcolor="#FFFFFF">&nbsp;</td>
  		<td width="75%">
<p align="center"> <a href="redir_drummond.php">Rediriger vers Drummond (Collection Other de TR)</a> </p>

<p align="center"> <a href="redir_sct.php">Rediriger vers Sainte-Catharines (Collection Other de TR)</a> </p>
