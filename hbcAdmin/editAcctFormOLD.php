...
<form name="form3" method="post" action="getAccount.php" onSubmit="return formCheck(this);">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="8"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial"><?php echo "$heading"; ?></font></b></td>
            		</tr>
...
?>
				...
				<tr bgcolor="#DDDDDD">
					...
					<td colspan="3" align="left" ><input name="purchase_unit" type="radio" value="single" <?php if($accountData["purchase_unit"]=="single") echo " checked"; ?> class="formField" />single
...
<font color="#FF0000" size="1" face="Arial, Helvetica, sans-serif"><b>Edit Account cannot be reversed.</b></font></td>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="6"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">Stock Discounts</font></b></td>
            		</tr>
<?php
...
if($tableCounter!=3)
	echo"</tr>";
echo "<tr><td align=\"center\" colspan=\"6\"><input type=\"hidden\" name=\"user_id\" value=\"$accountData[user_id]\" /><input type=\"hidden\" name=\"pkey\" value=\"$accountData[primary_key]\" /><input name=\"updateDisc\" type=\"submit\" value=\"Update Discounts\" class=\"formField\" /></td></tr></form>";
?>
</table>