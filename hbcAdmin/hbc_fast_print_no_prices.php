...
switch($_SESSION["accessid"]){
		...
		case 2: 	$User_ID_IN = " ('88666','88433','88430','88444','88439','88438','88416','88429','88441','88435','88434','88432','88431','88442','88440','88414','88411','88408','88403','88449','88405','88409','redo_hbc') ";	break; //ACCES POUR DANIELLE' MOI' LAB STC   
	...
	if (strlen($the_order_num)==5)
	{
		...
		if ($JobType <>'remote edging'){
			if($_SESSION["accessid"]<>2){
				$queryUpdate	 = "UPDATE orders SET frame_sent_saintcath ='yes' WHERE order_num = $the_order_num";
...
<html>
<head>
<title>HBC Fast Printing Tool (NO PRICES)</title>
...
<form  method="post" name="verification" id="verification" action="hbc_fast_print_no_prices.php">
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="formField">
            	<tr bgcolor="#000000">
            		<td align="center" colspan="4"><b><font color="#FFFFFF" size="1" face="Helvetica, sans-serif, Arial">HBC Fast Printing Tool (NO PRICES)</font></b></td>
            	</tr>
				...
				<tr bgcolor="#DDDDDD">
					<td align="center" valign="middle" nowrap bgcolor="#DDDDDD" ><div style="font-size:14px;" align="center">
                        ...
                        <br><br><br><br><div><strong>1-</strong>Please type your order number separated by a comma</div>					<textarea cols="20" name="order_num" style="font-size:16px;"  rows="10" id="order_num" class="formField"><?php if($_POST[rpt_search]=="Verifier"){
...
<form  method="post" name="update_status" id="update_status" action="hbc_fast_print_no_prices.php">
			<?php 
			if ($rptQuery!=""){
