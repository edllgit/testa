...
<tr valign="top">
    ...
    <tr bgcolor="#DDDDDD">
    	...
    	<td width="5%" align="left" valign="middle" nowrap="nowrap"><?php echo $adm_sphere_txt;?></td>
        <td width="5%" align="left" valign="middle" nowrap="nowrap"><?php echo $adm_cylinder_txt;?></td>
