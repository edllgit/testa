...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="formField print_hidden">
    ...
    <tr>    
        ...
        <form action="getAccount.php" method="post" name="form2" id="form2">
            ...
            $resultApprove=mysqli_query($con,$query) or die ($adm_error1_txt);
	...
	<?php if (($_SESSION["accessid"] <> '225')&&($_SESSION["accessid"] <> '226')) { ?>
     <tr class="formField print_hidden">
    	<tr class="formField print_hidden">
    	<td align="left">
        	<p><a style="text-decoration:none;" href="hbc_fast_print.php?reset=y">
       		<?php if ($mylang == 'lang_french' || $mylang == 'lang_France'){
			echo 'HBC Impression Rapide';
			}else {
			echo 'HBC Fast Print';
			}
			?></a></p></td>
	...
	<?php if ($_SESSION["accessid"] == '2') { ?>
     <tr class="formField print_hidden">
    	<tr class="formField print_hidden">
    	<td align="left">
        	<p><a style="text-decoration:none;" href="hbc_fast_print_no_prices.php?reset=y">
       		<?php if ($mylang == 'lang_french' || $mylang == 'lang_France'){
			echo 'HBC Impression Rapide <strong>(sans prix)</strong>';
			}else {
			echo 'HBC Fast Print <strong>(no price)</strong>';
			}
			?></a></p></td>
    </tr>    
    <?php  }//end if ?>
   ...
   <?php   
    ...
    $afficherAccounting = "yes";
	 ...
	 if ($extra_product_pricing == "yes"){ ?>
    <tr bgcolor="#DDDDDD">
    	<td align="left" bgcolor="#000000"><b><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><?php echo $adm_titlemast_pricing;?></font></b></td>
    </tr>
    <tr bgcolor="#DDDDDD">
    	<td align="left"><p><a style="text-decoration:none;" href="extra_product_pricing.php"><?php echo $adm_extraproduct_txt;?> </a></p></td>
    </tr>
    <?php  }//end if extra_product_pricing ?> 

        
    <tr bgcolor="#DDDDDD">
        <td align="left" bgcolor="#000000">
            <b><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">
			<?php if ($mylang == 'lang_french' || $mylang == 'lang_France'){
            echo 'AUTRES';
            }else {
            echo 'OTHERS';
