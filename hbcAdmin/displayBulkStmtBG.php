<?php
	if ($listItem['product_line']=="directlens")
		{$dl_logo_file="direct-lens_logo.gif";
		$pl_text="Direct-Lens";}
	elseif ($listItem['product_line']=="mybbgclub")
		{$dl_logo_file="bbgclub_logo.gif";
		$pl_text="MyBBGClub";}
	elseif ($listItem['product_line']=="aitlensclub")
		{$dl_logo_file="logos/aitclub_logo.gif";
		$pl_text="AIT Lens Club";}
	else
		{$dl_logo_file="lensnet_logo.gif";
		$pl_text="LensNet Club";}
		?>

<table width="750" border="0"cellpadding="3" cellspacing="0" align="center"><tr><td align="left"><img src="../logos/<?php echo "$logo_file"; ?>" /><td align="right"><img src="../logos/<?php echo "$dl_logo_file"; ?>" width="200" height="60" /></td></tr></table>
...
"$listItem[BG_address1]";?></strong></td>
                ...
                <td width="520" class="formCellNosides"><strong><?php echo 
"$listItem[BG_address2]";?></strong></td>
              </tr>
              <tr >
