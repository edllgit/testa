...
<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
         <tr >
                <td colspan="7" bgcolor="#D5EEF7" class="tableSubHead"><?php echo $lbl_trayref_txt;?> - <?php echo $listItem[tray_num] ?></td>
...
<input name="pkey" type="hidden" value="<?php echo $listItem[primary_key]?>" />                  </td>     </form>   
              ...
              <tr>
                <td align="right" class="formCellNosides"><span class="tableSubHead"><?php echo $listItem[eye] ?></span></td>
                <td align="center" class="formCellNosides"><span class="tableSubHead"><?php echo $listItem[order_product_name] ?></span></td>
