...
<input name="order_num" type="hidden" value="<?php echo $listItem[order_num]?>" /></td></form> 
		 <?php 
			...
			echo 'R.E.';
				...
				<td rowspan="8" align="right" valign="top" class="formCellNosidesRA">
            ...
            <?php  
			 ...
			 $resultEdging = mysqli_query($con,$queryEdging)	or die ("Could not select items");
			 $CountEdging  = mysqli_num_rows($resultEdging);
