...
FROM orders, labs
WHERE orders.prescript_lab = labs.primary_key
AND user_id IN ('montreal','montrealsafe')
...
$subject      = "Entrepot de le lunette Montreal Zone Tendance 1: commandes en cours";
...
VALUES('Entrepot lunette Montreal Zone Tendance 1 HBC Orders In production 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_mtl_zt1.php')"; 					
