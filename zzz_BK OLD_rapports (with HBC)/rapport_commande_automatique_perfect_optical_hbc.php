...
qui ont été commandés durant la journée par (Les magasins HBC ou Griffé Trois-Rivières)
...
$CollectionsAEvaluer =" AND supplier IN ('ELLE-CA','ESPRIT-CA','CHARMANT-CA','STRELLSON-CA','CHARMANT','STRELLSON','ELLE','ESPRIT','RIPCURL')";
...
$ordersnum=mysqli_num_rows($rptResult);
		...
		if ($ordersnum==0){
			$message.="No Frame in these collections  ('ELLE-CA','ESPRIT-CA','CHARMANT-CA','STRELLSON-CA','CHARMANT','STRELLSON','ELLE','ESPRIT','RIPCURL') have been ordered yesterday.";
		}
echo '<br><br>' . $message;
...
$subject="Perfect Optical HBC Frames order(s) of the day: $hier";
