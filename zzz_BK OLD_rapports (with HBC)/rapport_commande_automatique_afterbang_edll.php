...
/*
$Ilya6jours = '2021-03-29';
$aujourdhui = '2021-04-04';
*/
...
$CollectionsAEvaluer =" AND supplier IN ('AFTERBANG')";
...
$ordersnum=mysqli_num_rows($rptResult);
		...
		if ($ordersnum==0){
			$message.="No Frame in the collection Afterbang have been ordered in the last week.";
		}
echo '<br><br>' . $message;
...
$send_to_address = array('rapports@direct-lens.com');//LIVE
$send_to_address = array('warranty@afterbangeyewear.com','monture@entrepotdelalunette.com','renouvellement@entrepotdelalunette.com');//LIVE
...
$subject="AFTERBANG EDLL Frames order(s) Between $Ilya6jours and $aujourdhui";
