...
$CollectionsAEvaluer =" AND supplier IN ('MICOLII','JUMP EYEWEAR')";
...
$send_to_address = array('rapports@direct-lens.com');//LIVE
$send_to_address = array('micoliieyewear@gmail.com','info@kooloptic.com','monture@entrepotdelalunette.com','renouvellement@entrepotdelalunette.com');
...
$subject="[Frames sold Report] Micolii EDLL--> [$dateilya3jours - $hier] ";
