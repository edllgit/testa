...
//a) aller chercher les employés qui ont fait des ventes pour ce magasin, durant la période qui a été  sélectionnée
...
$resultDistinctEmployees = mysqli_query($con, $queryDistinctEmployeesofThisStore)	or die  ('I cannot select items because: '. $querySVwithAR . mysqli_error($con));
while ($DataDistinctEmployees   = mysqli_fetch_array($resultDistinctEmployees,MYSQLI_ASSOC){
echo '<br>'.$DataDistinctEmployees[salesperson_id];	
