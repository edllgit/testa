...
$subject      = "HBC Store #88408-Oshawa: $ordersnum Orders in Progress";
...
//Log email
	...
	if($response){ 
		//log_email("REPORT: Entrepot de le lunette 88408: commandes en cours",$EmailEnvoyerA,"SENT",$_SERVER['HTTP_USER_AGENT']);
		echo '<div class="alert alert-success" role="alert"><strong>Email Sent Sucessfully to:'. $EmailEnvoyerA.'</strong></div>';
	}else{
		//log_email("REPORT: Entrepot de le lunette 88408: commandes en cours",$EmailEnvoyerA,"FAILED",$_SERVER['HTTP_USER_AGENT']);
