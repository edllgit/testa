...
AND user_id IN ('entrepotdr') AND order_num not in (1329921)
...
FROM orders, labs
WHERE orders.prescript_lab = labs.primary_key
AND user_id IN ('entrepotdr','safedr')
...
$subject      = "Entrepot de la lunette Drummondville: commandes en cours";
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) 
				VALUES('Rapport commandes en cours Drummondville', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_drummondville.php')"; 					
