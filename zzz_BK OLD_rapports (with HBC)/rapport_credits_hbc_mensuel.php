...
if ($ordersnum!=0){
	...
	//Associative Array	
		while ($listItem=mysqli_fetch_array($result,MYSQLI_ASSOC)){
			...
			$queryCreditReason 	= "SELECT mc_description FROM memo_codes WHERE mc_lab= 1 AND memo_code= '$listItem[mcred_memo_code]'";
...
$subject      = "HBC Monthly Credit Report:$MoisConcerner  $year  ";
