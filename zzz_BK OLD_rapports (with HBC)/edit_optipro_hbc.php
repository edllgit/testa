...
if ($_POST[submit] == 'Sauvegarder les modifications' ){
	...
	$resultUpdate =  mysqli_query($con,$queryUpdate) or die  ('I cannot select items because 6: ' . mysqli_error($con));
...
//echo '<br>'. $rptQuery . '<br>';	   
$resultQuery = mysqli_query($con,$rptQuery) or die  ('I cannot select items because 6: ' . mysqli_error($con));
...
<body>
<form  method="post" name="edit_optipro" id="edit_optipro" action="edit_optipro_hbc.php">
...
<p align="center"><h3>Modifier une erreur Optipro</h3></p>
 ...
 <tr>
  ...
  <tr>
   ...
   <br><br>
    <div align="center"><a href="rapport_erreurs_optipro_hbc.php">Retour à la liste d'erreurs Optipro</a></div>
</form>
