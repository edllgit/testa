...
AND user_id IN ('fredericton','frederictonsafe')
...
$subject      = "Entrepot de le lunette Fredericton: commandes en cours";
...
//Log email
	...
	if($response){ 
		//log_email("REPORT: Entrepot de le lunette Fredericton: commandes en cours",$EmailEnvoyerA,"SENT",$_SERVER['HTTP_USER_AGENT']);
		echo '<div class="alert alert-success" role="alert"><strong>Email Sent Sucessfully to:'. $EmailEnvoyerA.'</strong></div>';
	}else{
		//log_email("REPORT: Entrepot de le lunette Fredericton: commandes en cours",$EmailEnvoyerA,"FAILED",$_SERVER['HTTP_USER_AGENT']);
...
VALUES('Rapport commandes en cours Fredericton 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_fredericton.php')"; 					
