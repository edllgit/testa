...
-20
Inclus les montures de la collection: KUBIK ONE vendu par les magasins Entrepot de la lunette SI ET UNIQUEMENT SI ELLES SONT COMMANDÉS AVEC UN PRODUIT 'PACKAGE K-ONE' dans Optipro.


[HKO DOIT  être avisé de ces  ventes, car c'est eux qui enverront  les montures nécessaires à leur laboratoire.]

(Les montures KUBIK ONE qui sont installées en magasin resteront en magasin. Eelles ne quitteront JAMAIS pour le laboratoire)
...
$send_to_address = array('rapports@direct-lens.com');//LIVE: courriel de Wayne et Bella enlevé a leur demande
$send_to_address = array('michelle.chan@quickwonder.com','riazzolino@opticalvisiongroup.com','monture@entrepotdelalunette.com','renouvellement@entrepotdelalunette.com');
//$send_to_address = array('rapports@direct-lens.com');//TEST
...
$subject="KUBIK ONE [Frames sold Report] $DateilYa6Jours-$DateduJour";
