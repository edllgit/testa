...
//$ladate = "2021-04-02";//Hard coder une date	
...
$ordersnum=mysqli_num_rows($rptResult);
		...
		$message.="<tr><td colspan=\"11\">Ce rapport contient les montures qui sont vendus par nos magasins HBC avec le code source V1</td></tr><tr bgcolor=\"CCCCCC\">
...
switch($listItem[user_id]){
	case '88403': 		$magasin = '#88403 Hudsons Bay Optical  Bloor St.'; 		break;
	case '88408': 		$magasin = '#88408 Hudsons Bay Optical Oshawa'; 			break;
	case '88409': 		$magasin = '#88409 Hudsons Bay Optical Eglinton'; 			break;
	case '88411': 		$magasin = '#88411 Hudsons Bay Optical Sherway'; 			break;
	case '88414': 		$magasin = '#88414 Hudsons Bay Optical Yorkdale'; 			break;
	case '88416': 		$magasin = '#88416 Hudsons Bay Optical Vancouver DTN'; 		break;
	case '88429': 		$magasin = '#88429 Hudsons Bay Optical Saskatoon'; 			break;
	case '88431': 		$magasin = '#88431 Hudsons Bay Optical  Calgary DTN'; 		break;
	case '88433': 		$magasin = '#88433 Hudsons Bay Optical Polo Park'; 			break;
	case '88434': 		$magasin = '#88434 Hudsons Bay Optical Market Mall'; 		break;
	case '88435': 		$magasin = '#88435 Hudsons Bay Optical West Edmonton'; 		break;
	case '88438': 		$magasin = '#88438 Hudsons Bay Optical Metrotown'; 			break;
	case '88439': 		$magasin = '#88439 Hudsons Bay Optical Langley'; 			break;
	case '88440': 		$magasin = '#88440 Hudsons Bay Optical Rideau'; 			break;
	case '88444': 		$magasin = '#88444 Hudsons Bay Optical Mayfair'; 			break;
	case '88666': 		$magasin = '#88666 Griffé'; 								break;
	case 'redo_hbc':  	$magasin = 'Compte de Reprise';     						break; 

	default: $magasin = "Inconnu";
}
		...
		$message.="<tr bgcolor=\"CCCCCC\"><td colspan=\"7\">Number of Orders: $ordersnum</td></tr>
		</table>";
...
$subject="Rapport Backstore HBC $ladate";
