...
$CollectionsAEvaluer =" AND supplier IN ('SUNTRENDS')";
...
$ordersnum=mysqli_num_rows($rptResult);
		...
		if ($ordersnum==0){
			$message.="No Frame in the collection SUNTRENDS has been sold in this period.";
		}
echo '<br><br>' . $message;
...
$subject="SUNTRENDS HBC Monthly Franchise [Frames sold Report]  '$AnneeEnCours-$JourDebut' - '$AnneeEnCours-$JourFin'";
