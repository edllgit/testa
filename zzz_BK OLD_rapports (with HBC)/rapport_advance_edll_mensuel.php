...
for ($i = 1; $i <= 14 ; $i++) {
		...
		switch($i){
			...
			case  7:  $Userid =  " ('entrepotifc')";    $Partie = 'Trois-Rivières';	$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  8:  $Userid =  " ('gatineau')";		$Partie = 'Gatineau';	 	$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  9:  $Userid =  " ('laval')";    		$Partie = 'Laval';	  		$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  10: $Userid =  " ('longueuil')";    	$Partie = 'Longueuil';	  	$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  11: $Userid =  " ('stjerome')";    	$Partie = 'Saint-Jérôme';	$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  12: $Userid =  " ('terrebonne')";    	$Partie = 'Terrebonne';		$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  13: $Userid =  " ('edmundston')";    	$Partie = 'Edmundston';		$send_to_address = array('rapports@direct-lens.com');break;
			
			
			case  14: $Userid =  " ('warehousehal')";   $Partie = 'Halifax';		$send_to_address = array('rapports@direct-lens.com');break;
		}//End Switch
