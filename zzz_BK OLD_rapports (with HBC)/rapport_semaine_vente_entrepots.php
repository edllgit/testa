...
WHERE accounts.user_id IN ('entrepotifc', 'entrepotdr', 'laval', 'warehousehal','terrebonne','sherbrooke','chicoutimi','levis','longueuil','granby','entrepotquebec','montreal','gatineau','stjerome','edmundston','vaudreuil','sorel','fredericton')
