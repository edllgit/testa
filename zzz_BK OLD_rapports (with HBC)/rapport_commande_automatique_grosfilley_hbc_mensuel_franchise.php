...
AND  redo_order_num is null
$CollectionsAEvaluer
AND order_date_processed BETWEEN '$2020-11-01' AND '$AnneeEnCours-$JourFin'
GROUP BY orders.order_num ORDER BY user_id";
...
$subject="[Frames sold Report] Grosfilley HBO Monthly Franchise -->  ['$AnneeEnCours-$JourDebut' AND '$AnneeEnCours-$JourFin']";
