<?php
//HKO: partie Reseau DirectLab: ne contient pas de EDLL 
...
switch($listItem["user_id"]){//N'inclue pas les compte SAFE
	...
	$subject	  = "Orders of the day RDL - HKO";
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) 
					VALUES('Rapport redirection HKO (Aucun EDLL) 2.0', '$time','$today','$heure_execution','rapport_redirection_hko.php')"; 		
