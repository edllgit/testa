...
switch($Plateforme){
	...
	case 'rdl':  echo 'Reseau DirectLab'; 
...
if ($ordersnum!=0){
	...
	$subject      = "Orders of the day RDL - GKB: $today ";
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) 
					VALUES('Rapport redirection GKB (Aucun edll) 2.0', '$time','$today','$heure_execution','rapport_redirection_gkb.php')"; 		
