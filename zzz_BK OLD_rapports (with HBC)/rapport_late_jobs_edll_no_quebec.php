...
'delay issue 5','delay issue 6'	,	'waiting for frame','waiting for frame swiss','waiting for frame knr','waiting for shape'	,'re-do','verifying','in transit','order completed','on hold','scanned shape to swiss','') 
 AND order_num<>-1
