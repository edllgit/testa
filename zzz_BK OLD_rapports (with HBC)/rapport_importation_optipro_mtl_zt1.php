<?php
//RAPPORT :Entrepot de Montréal ZT1
...
WHERE user_id IN ('montreal','montrealsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Montréal ZT1</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Montréal ZT1 commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$subject      = "Rapport Importation Optipro Montréal ZT1: ".$today;
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page)
 VALUES('Rapport importation Optipro MTL ZT1 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_mtl_zt1.php')"; 					
