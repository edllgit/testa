...
AND  redo_order_num is null
$CollectionsAEvaluer
AND order_date_processed BETWEEN '2022-05-01' AND '2022-05-31'
GROUP BY orders.order_num ORDER BY user_id";
*/
...
$send_to_address = array('thierry.a@grosfilley.com','grosfilley@grosfilley.com','monture@entrepotdelalunette.com','renouvellement@entrepotdelalunette.com');
