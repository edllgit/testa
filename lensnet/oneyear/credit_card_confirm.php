...
//Since the customer already paid by credit card, we activate his collections
...
sendEmail($DataDetail[company], $promo, 'thahn@direct-lens.com','credit card');
sendEmail($DataDetail[company], $promo, 'dbeaulieu@direct-lens.com','credit card');
