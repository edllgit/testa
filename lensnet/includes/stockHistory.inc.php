...
<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
         <tr >
                <td colspan="5" bgcolor="#D7E1FF" class="tableSubHead">Product - <?php print $listItem[order_product_name] ?></td>
                <td width="76" bgcolor="#D7E1FF" class="tableSubHead">&nbsp;</td>
                <td width="128" bgcolor="#D7E1FF"  class="formCellNosidesRA" >&nbsp;
                   </td>    
  </tr>
              <tr >
