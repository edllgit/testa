...
<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
         <tr >
                <td colspan="6" bgcolor="#D7E1FF" class="tableSubHead"><?php echo $lbl_productname_txt_stock;?> - <?php print $listItem[order_product_name] ?></td>
                <form id="<?php print $listItem[order_item_number] ?>" name="<?php print $listItem[order_item_number] ?>" method="post" action="basket.php">
                <td width="121" bgcolor="#D7E1FF"  class="formCellNosidesRA" >
...
<input name="pkey" type="hidden" value="<?php print $listItem[primary_key]?>" />                  </td>     </form>   
              ...
              <tr>
                ...
                <td align="center" class="formCellNosides"><?php print $listItem[re_cyl] ?></td><form id="<?php print $listItem[order_item_number] ?>" name="<?php print $listItem[order_item_number] ?>" method="post" action="basket.php" onSubmit="return validate_quantity(this)"><td align="center" valign="top" class="formCellNosidesCenter">
