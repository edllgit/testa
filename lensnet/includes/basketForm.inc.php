...
<input name="mypkey" type="hidden" id="mypkey" value="<?php print $_SESSION['PrescrData']['mypkey'];?>" />
              <tr >
				...
				$totalShippingRX= $DataOrder[NbORder] * $labItem[ship_chg_rx];//Multiplié par le nombre de commande
				//$totalShippingRX=  $labItem[ship_chg_rx];//Multiplié par le nombre de commande
				}		
				if ($stock_quantity>0)
