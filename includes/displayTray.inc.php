...
<tr ><td colspan="8" bgcolor="#000098" class="tableHead"><?php echo $lbl_currenttrays_txt;?>&nbsp; </td>
  </tr></table>
<?php

if ($_SESSION["ITEM_NUMBER"]== 0){ /* no trays to list */
	print "<table width=\"650\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\"  class=\"formBox\"><tr><td colspan=\"8\" class=\"formCell\">There are currently no tray items.</td></tr></table>";
	}else{
