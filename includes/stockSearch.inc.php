...
$query="select diameter,price,price_can,price_eur,prices.product_name,products.mfg,products.product_name,products.primary_key,material,filter,coating,d_index,sph_base,cyl_add from products,prices WHERE coating='$COATING' AND material='$MATERIAL' AND sph_base='$SPHERE' AND products.product_line='directlens' AND cyl_add='$CYLINDER'  AND d_index='$INDEX' and type='stock' AND products.product_name=prices.product_name AND prices.".$currency."!=0 and products.product_name not like '%somo%' ORDER by products.product_name asc"; //TEAM LEADERS SECTION

//echo $query;

$result=mysql_query($query)		or die  ('I cannot select items because: ' . mysql_error() . $query);
$usercount=mysql_num_rows($result);
$usercountOeilDroit=mysql_num_rows($result);
if ($usercount != 0){
...
?><table width="650" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
              <tr >
                <td colspan="10" bgcolor="#000098" class="tableHead"><?php echo $lbl_reavailprod_txt;?>&nbsp;</td>
  </tr>
              <tr>
                ...
                <td align="center" class="formCell"><?php echo $lbl_index_txt_stock;?>&nbsp;</td> 
                 ...
                 <td align="center" class="formCell"><?php echo 'Diameter';?>&nbsp;</td>
...
$query="select  diameter,price,price_can,price_eur,prices.product_name,products.mfg,products.product_name,products.primary_key,material,filter,coating,d_index,sph_base,cyl_add from products,prices WHERE coating='$COATING' AND material='$MATERIAL' AND sph_base='$SPHERE' AND products.product_line='directlens' AND cyl_add='$CYLINDER' and products.product_name not like '%tokai%' and products.product_name not like '%somo%' AND d_index='$INDEX' and type='stock' AND products.product_name=prices.product_name AND prices.".$currency."!=0 ORDER by products.product_name asc"; //TEAM LEADERS SECTION
...
?><table width="650" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
              <tr >
                <td colspan="10" bgcolor="#000098" class="tableHead"><?php echo $lbl_leavailprod_txt;?>&nbsp;</td>
  </tr>
              <tr>
                <td align="center"  class="formCell"><?php echo $lbl_manufacturer_txt_stock;?>&nbsp;</td>
                <td align="center"  class="formCell"><?php echo $lbl_productname_txt_stock;?>&nbsp;</td>
