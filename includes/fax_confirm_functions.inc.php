...
function sendFaxStockConfirmation($fromAddress,$logo_file,$orderNum,$send_to_address,$user_id,$faxNum){//STOCK BULK AND TRAY CONFIRMATION
...
function sendFaxPrescriptionConfirmation($fromAddress,$logo_file,$orderNum,$send_to_address,$user_id,$sendPrices,$faxNum){//PRESCRIPTION CONFIRMATION
...
<title>ORDER</title>
	...
	$message.='<table width="650" border="1" align="center" cellpadding="3" cellspacing="0"><tr><td align="left">Acc. No. 561408 ';
	$message.=$listItem[po_num];
	$message.='</td></tr></table><br>';
