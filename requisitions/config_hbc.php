...
?>
  <head>
    ...
    <title>Configuration des paramètres HBC</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="config_hbc" method="post" action="config_hbc.php">
   

  <?php  include("inc/menu.inc.php"); ?>
	  
<div class="container">
<b>Configuration des paramètres HBC</b>
 		
 <?php   
//Afficher le fournisseur sélectionné
$rptQuery="SELECT * FROM configurations WHERE config_edll_ou_hbc='hbc'";
