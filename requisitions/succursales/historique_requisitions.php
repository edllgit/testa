...
<tr>
<td colspan="8" align="center"><b>Historique</b></td>
</tr>
...
$rptQuery="SELECT * FROM requisitions WHERE req_edll_ou_hbc='edll' AND user_id='$_SESSION[idMobile]' AND req_status<>'panier' ORDER BY req_id";
//echo $rptQuery . '<br><br>';
...
echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_requisition.php?req_id=$listItem[req_id]\">$listItem[req_id]</a></td> 
