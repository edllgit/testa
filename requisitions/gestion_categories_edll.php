...
<tr>
	<td colspan="7" align="center"><b>GESTION DES CATÉGORIES DE PRODUITS EDLL</b></td>
</tr>

<tr><td colspan="7" align="center">&nbsp;</td></tr>

<tr>
	<td colspan="7" align="center"><a href="creer_categorie_edll.php">Créer une Catégorie</a></td>
</tr>
...
$rptQuery="SELECT * FROM categories  WHERE cat_edll_ou_hbc='edll' ORDER BY cat_id";
...
$Prod_status = 'Inactif';
	...
	echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_categorie_edll.php?cat_id=$listItem[cat_id]\">$listItem[cat_id]</a></td> 
