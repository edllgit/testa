...
?>
  ...
  <body>
  <br><br><br><br>
  <form name="modification_produit_hbc" method="post" action="modifier_produit_hbc.php">
...
<b>Modification d'un produit HBC</b>
...
<td>
 <select name="categorie" class="formText" id="categorie">
  <?php
$queryCat="SELECT * from categories WHERE cat_edll_ou_hbc='hbc'"; /* select all openings *
...
<td><select name="fournisseur" class="formText" id="fournisseur">
  <?php
$queryFourn="SELECT * from fournisseurs WHERE fourn_edll_ou_hbc='hbc' "; /* select all openings *
