...
?>
  <head>
    ...
    <title>Gestion des Réquisitions HBC</title>
    <!-- Bootstrap core CSS -->
...
<tr>
<td colspan="8" align="center"><b>GESTION DES RÉQUISITIONS HBC</b></td>
</tr>
...
$rptQuery="SELECT * FROM requisitions WHERE req_edll_ou_hbc='hbc' AND req_status='panier' ORDER BY req_id";
//echo $rptQuery . '<br><br>';
...
while ($DataTotalRequisition=mysqli_fetch_array($resultTotalRequisition,MYSQLI_ASSOC)){
	...
	echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_requisition_hbc.php?req_id=$listItem[req_id]\">$listItem[req_id]</a></td> 
