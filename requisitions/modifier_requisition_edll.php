...
if ($_POST[SupprimerItem] == "Supprimer"){
 $ID_Requisition = $_POST[id_a_effacer]; 
	...
	header("Location: modifier_requisition_edll.php?req_id=$REQ_ID");
	exit();
}
...
<b>Réquisition EDLL #<?php echo $ID_Requisition; ?></b>    
...
<td width="100" align="center"><b>Nombre d'item inclus (par commande)</b></td>
