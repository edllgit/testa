...
?>
  <head>
    ...
    <title>Gestion des succursales EDLL</title>
    <!-- Bootstrap core CSS -->
...
<tr>
	<td colspan="7" align="center"><b>GESTION DES SUCCURSALES EDLL</b></td>
</tr>
...
$rptQuery="SELECT * FROM succursales  WHERE succ_edll_ou_hbc='edll' ORDER BY succ_nom";
...
$Succ_status = 'Inactif';
	...
	echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_succursale_edll.php?succ_id=$listItem[succ_id]\">$listItem[succ_id]</a></td> 
