...
?>
  <head>
    ...
    <title>Modifier une succursale HBC</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="modification_succursale_hbc" method="post" action="modifier_succursale_hbc.php">
...
$rptQuery="SELECT * FROM succursales WHERE succ_id = $_REQUEST[succ_id]  AND succ_edll_ou_hbc='hbc' ORDER BY succ_nom DESC";
...
<br>
<b>Modification d'une succursale HBC</b>
...
<a href="gestion_succursales_hbc.php">Retour à la liste des succursales HBC</a><br>
