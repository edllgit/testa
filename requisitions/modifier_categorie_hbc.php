...
?>
  <head>
    ...
    <title>Modifier un produit HBC</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="modification_categorie_hbc" method="post" action="modifier_categorie_hbc.php">
...
$rptQuery="SELECT * FROM categories WHERE cat_id = $_REQUEST[cat_id]  AND cat_edll_ou_hbc='hbc' ORDER BY cat_nom_fr DESC";
...
<b>Modification d'une catégorie HBC</b>
