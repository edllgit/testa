...
?>
  <head>
    ...
    <title>Gestion des Produits EDLL</title>
    <!-- Bootstrap core CSS -->
...
<table width="1230" cellpadding="2" border="1"  cellspacing="0" class="TextSize">
<tr>
<td colspan="<?php echo $LargeurColonne ?>" align="center"><b>GESTION DES PRODUITS EDLL</b></td>
</tr>
<tr><td colspan="<?php echo $LargeurColonne ?>" align="center">&nbsp;</td></tr>

<tr><td colspan="<?php echo $LargeurColonne ?>" align="center"><a href="creer_produit_edll.php">Créer un produit</a></td></tr>
...
$rptQuery="SELECT * FROM produits WHERE prod_edll_ou_hbc='edll' ORDER BY prod_description_fr";
//echo $rptQuery . '<br><br>';
...
$queryCategorie = "SELECT * FROM categories WHERE cat_edll_ou_hbc='edll' AND cat_id = $listItem[categorie]";
...
$queryFournisseur 	= "SELECT * FROM fournisseurs WHERE fourn_edll_ou_hbc='edll' AND fourn_id = $listItem[fournisseur]";
...
$fourn_nom_fr 		= $DataFournisseur[fourn_nom_fr];
	...
	echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_produit_edll.php?prod_id=$listItem[prod_id]\">$listItem[prod_id]</a></td> 
