...
?>
  <head>
    ...
    <title>Modifier un Fournisseur EDLL</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="modification_fournisseur_edll" method="post" action="modifier_fournisseur_edll.php">
...
<b>Modification d'un fournisseur EDLL</b>
...
<a href="gestion_fournisseurs_edll.php">Retour à la liste des Fournisseurs EDLL</a><br>
