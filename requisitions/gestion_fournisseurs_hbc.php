...
?>
  <head>
    ...
    <title>Gestion des Fournisseurs HBC</title>
    <!-- Bootstrap core CSS -->
...
$rptQuery="SELECT * FROM fournisseurs  WHERE fourn_edll_ou_hbc='hbc' ORDER BY fourn_id";
...
$Prod_status = 'Inactif';
	...
	echo 	"<tr>
			<td align=\"center\"><a href=\"modifier_fournisseur_hbc.php?fourn_id=$listItem[fourn_id]\">$listItem[fourn_id]</a></td> 
