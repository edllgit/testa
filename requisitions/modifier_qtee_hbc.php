...
if ($_POST[MettreAJourItem] == "Mettre a jour"){
	...
	$PathRedirection = "modifier_requisition_hbc.php?req_id=". $req_id;
...
?>
  ...
  <body>
  <br><br><br><br>
  <form name="modifier_qtee_hbc" method="post" action="modifier_qtee_hbc.php">
...
<b>Modifier la quantité d'un item</b>   <a href="modifier_requisition_hbc.php?req_id=<?php echo "$DataReqID[req_id]"; ?>">Retour à la réquisition</a>
