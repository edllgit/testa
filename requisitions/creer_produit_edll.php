...
if ($_POST[editProduct] == "Sauvegarder"){
	...
	VALUES ('$prod_description_en','$prod_description_fr','$prod_prix_unitaire','$prod_status', '$fournisseur','$categorie','edll',
	'$prod_date_creation','$prod_question_supplementaire','$prod_code','$prod_question_choix_reponse','$prod_choix_de_reponses','$prod_nombre_item_inclus')";
...
?>
  <head>
    ...
    <title>Créer un produit EDLL</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="creer_produit_edll" method="post" action="creer_produit_edll.php">
   <?php  include("inc/menu.inc.php"); ?>
	  
<div class="container">
<br>
 <b>Créer un produit EDLL</b>
...
<tr><td>&nbsp;</td></tr>
 ...
 <td><select name="categorie" class="formText" id="categorie">
  <?php
$queryCat="SELECT * from categories WHERE cat_edll_ou_hbc='edll' AND cat_status=1 "; /* select all openings */
...
<tr><th>Fournisseur:</th>   
 <td><select name="fournisseur" class="formText" id="fournisseur">
  <?php
$queryFourn="SELECT * from fournisseurs WHERE fourn_edll_ou_hbc='edll' AND fourn_status=1 "; /* select all openings */
