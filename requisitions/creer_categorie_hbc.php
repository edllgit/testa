...
if ($_POST[editProduct] == "Sauvegarder"){
	...
	$queryCreerCategorie= "INSERT INTO categories (cat_nom_en, cat_nom_fr, cat_edll_ou_hbc,  cat_status)	VALUES ('$cat_nom_en','$cat_nom_fr','hbc',1)";
...
?>
  <head>
    ...
    <title>Créer une catégorie HBC</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
  <br><br><br><br>
  <form name="creer_categorie_hbc" method="post" action="creer_categorie_hbc.php">
   <?php  include("inc/menu.inc.php"); ?>
	  
<div class="container">

 <br>
 <b>Créer une catégorie de produit HBC</b>
...
<a href="gestion_categories_hbc.php">Retour à la liste des Catégories HBC</a><br>
