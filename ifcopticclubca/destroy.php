...
switch($REFERER){
	...
	//Régulier
	//case 'http://c.direct-lens.com/ifcopticclubca/prescription.php': 	     $AdresseRetour = "http://c.direct-lens.com/ifcopticclubca/prescription.php";  break;	
	//case 'http://c.direct-lens.com/ifcopticclubca/sv_frame_form.php':      $AdresseRetour = "http://c.direct-lens.com/ifcopticclubca/prescription.php";  break;
	//case 'http://c.direct-lens.com/ifcopticclubca/prescription_frame.php': $AdresseRetour = "http://c.direct-lens.com/ifcopticclubca/prescription.php";  break;
