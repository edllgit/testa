<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
  <?php /*?><tr >
    ...
    <td align="left" class="formCellNosidesRA">Stock by Tray:<?php echo $totalTrayQuant;?>&nbsp;&nbsp;&nbsp;&nbsp;Stock
      by Bulk:<?php echo $totalBulkQuant;?>&nbsp;&nbsp;&nbsp;&nbsp;Prescription:<?php echo $prescrQuantity;?></td>
  </tr><?php */?>
</table>
  ...
  <table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
     ...
     <?php
		...
		echo "<tr ><td align=\"left\"  class=\"formCellNosides\">Additional Item:&nbsp;".$extra_product."</td>";
		echo "<td align=\"right\" valign=\"middle\" class=\"formCellNosidesRA\"><b>".$extra_product_price.'</b></td></tr>';
			...
			if ($_SESSION['account_type']=='normal') {
			 ?>
			<?php /*?>  <tr >
			  <td align="left" class="formCellNosides">Shipping: <?php echo $order_shipping_method; ?></td>
			  <td align="right" valign="middle" class="formCellNosidesRA"><?php echo $order_shipping_cost; ?></td>
              </tr><?php */?>
