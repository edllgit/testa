...
if ($_SESSION["ITEM_NUMBER"]== 0){ /* no trays to list */
	echo "<table width=\"770\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\"  class=\"formBox\"><tr><td colspan=\"8\" class=\"formCell\">There are currently no tray items.</td></tr></table>";
	}else{
