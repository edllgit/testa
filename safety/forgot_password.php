...
Merci, l'&eacute;quipe de Safety";
$message.="</body></html>";
}else{
//ENGLISH EMAIL 1 ACCOUNT
$subject = "Your Safety Account password";
$message="<html>";
$message.="<head></head>";
$message.="<body>Hi, <br>
Safety<br>
...
$message="<html>";
$message.="<head></head>";
$message.="<body>Bonjour,  Nous avons trouv&eacute;s plusieurs comptes correspondants &agrave; cette adresse email<br><br> Safety<br>";
...
$message="<html>";
$message.="<head></head>";
$message.="<body>Hi, We found many accounts with this email address <br><br> Safety<br>";

$queryACCOUNTS = "SELECT user_id, password from accounts WHERE product_line = '$product_line' AND email = '" .  $leEmail . "'";
$resultACCOUNTS=mysqli_query($con,$queryACCOUNTS) or die ("Could not find account ");
	while($DataACCOUNTS=mysqli_fetch_array($resultACCOUNTS,MYSQLI_ASSOC)){//step through each accounts	
