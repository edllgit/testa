...
<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
         <tr >
                <td colspan="6" bgcolor="#fbe6d8" class="tableSubHead"><?php echo $lbl_productname_txt_stock;?> - <?php print $listItem[order_product_name] ?></td>
                <form id="<?php print $listItem[order_item_number] ?>" name="<?php print $listItem[order_item_number] ?>" method="post" action="basket.php">
                <td width="121" bgcolor="#fbe6d8"  class="formCellNosidesRA" >
