       <tr >
              ...
              <td align="center" bgcolor="#f7e7dc" class="formCellNosides">
...
$_SESSION['PrescrData']['LE_ADD'];?></td>
              ...
              <tr >
               <td align="center" bgcolor="#f7e7dc" class="formCellNosides">&nbsp;</td>
                <td align="left" bgcolor="#f7e7dc" class="formCellNosides">&nbsp;</td>
                <td align="center" bgcolor="#f7e7dc" class="formCellNosides">PD</td>
                <td align="center" bgcolor="#f7e7dc" class="formCellNosides">
                <?php  if ($mylang == 'lang_french'){ 
			  echo  'Hauteur';
			  }else{
