...
<table width="770" border="0" align="center" cellpadding="3" cellspacing="0"  class="formBox">
         <tr >
                <td colspan="7" bgcolor="#fbe6d8" class="tableSubHead">
...
<input name="tray_num" type="hidden" value="<?php echo $listItem[tray_num]?>" />                  </td>     </form>   
              ...
              <tr>
                ...
                <td align="right" valign="top" class="formCellNosidesRA"><b><?php echo $lbl_moneysym_txt;?>
				<?php
				//$prodprice=money_format('%.2n', $listItem[order_product_price]/1.05);
				$prodprice=money_format('%.2n', $listItem[order_product_price]);
				 echo $prodprice; ?></b></td>
                <td colspan="3" align="right" valign="top" class="formCellNosidesRA"><b><?php echo $lbl_moneysym_txt;?>
				<?php 
				//$progTotalPrice =money_format('%.2n', $listItem[order_total]/1.05);
				$progTotalPrice =money_format('%.2n', $listItem[order_total]);
				echo $progTotalPrice; ?></b></td>
              </tr>
