...
//dartmouth:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot St-John
	 commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/dartmouth/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro dartmouth 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_dartmouth.php')"; 					
