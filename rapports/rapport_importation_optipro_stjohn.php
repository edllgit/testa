...
$message.="<tr><th>Entrepot stjohn</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//stjohn:   commandes cancellés car pas de coupon
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/stjohn/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro stjohn 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_stjohn.php')"; 					
