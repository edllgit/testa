...
//A RECOMMENTER (GATE)
//$ladate = "2024-05-01"; // Hard coder une date  la date debut
//$ladatef = "2024-05-01"; // Hard coder une date  la date fin */
...
$sevenDaysAgoDate = date("Y-m-d", $sevenDaysAgoTimestamp);

// Stocker les dates dans les variables respectives
$ladatef = $currentDate;
$ladate = $sevenDaysAgoDate;

// Affichage pour vérification
echo "Date actuelle : $ladatef\n";
echo "Date d'il y a 7 jours : $ladate\n";
