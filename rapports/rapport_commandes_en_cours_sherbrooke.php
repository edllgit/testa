...
AND user_id IN ('sherbrooke','sherbrookesafe')
...
$subject      = "Entrepot de le lunette Sherbrooke: commandes en cours";
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_en_cours_sherbrooke'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/sherbrooke/' . $nomFichier . '.html';
...
VALUES('Rapport commandes en cours Sherbrooke 2.0', '$time','$today','$timeplus3heures','rapport_commande_en_cours_sherbrooke.php') "  ; 					
