...
FROM orders, labs
WHERE orders.prescript_lab = labs.primary_key
AND user_id IN ('gatineau','gatineausafe')
...
$subject      = "Entrepot de la lunette Gatineau: commandes en cours";
...
//Log email
	...
	$nomFichier = 'r_commande_en_cours_Gati'. $timestamp;

	// Enregistrez le contenu HTML dans un fichier
	$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/gatineau/' . $nomFichier . '.html';
...
VALUES('Rapport commandes en cours Gatineau 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_gatineau.php')"; 					
