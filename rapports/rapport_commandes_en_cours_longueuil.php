...
AND user_id IN ('longueuil','longueuilsafe')
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','longueuil@entrepotdelalunette.com');


//$to_address = array('rapports@direct-lens.com');
$curTime	  = date("m-d-Y");	
$from_address ='donotreply@entrepotdelalunette.com';
$subject      = "Entrepot de le lunette Longueuil: commandes en cours";
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_en_cours_longueuil'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/longueuil/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page)
 VALUES('Rapport commandes en cours Longueuil 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_longueuil.php')"; 					
