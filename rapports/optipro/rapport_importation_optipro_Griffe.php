...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='1195542427918704'; // TODO: remplacer avec le code d'access pour  88666
}elseif ($_REQUEST[access]=='1195542427918704'){ // TODO: remplacer avec le code d'access pour  88666
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Griffe Lunetier</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
// 88666:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Griffe Lunetier commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','trois-rivieres@griffelunetier.com');
...
$subject      = "Rapport Importation Optipro  88666: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_ 88666'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/Griffe/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro  Griffe 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_Griffe.php')"; 					
