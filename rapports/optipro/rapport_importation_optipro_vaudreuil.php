...
WHERE user_id IN ('vaudreuil','vaudreuilsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Vaudreuil</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Vaudreuil:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Vaudreuil commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$subject      = "Rapport Importation Optipro Vaudreuil: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_vaudreuil'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/vaudreuil/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Vaudreuil 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_vaudreuil.php')"  ; 					
