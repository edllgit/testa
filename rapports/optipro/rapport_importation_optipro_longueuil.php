...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Longueuil</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
$subject      = "Rapport Importation Optipro Longueuil: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_longueuil'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/longueuil/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page)
 VALUES('Rapport importation Optipro Longueuil 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_longueuil.php')"; 					
