...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='1195542427918704';
}elseif ($_REQUEST[access]=='1195542427918704'){
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Granby</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Granby:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Granby commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$subject      = "Rapport Importation Optipro Granby: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_granby'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/granby/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Granby 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_granby.php')"; 					
