...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='215874699598';
}elseif ($_REQUEST[access]=='215874699598'){
...
WHERE user_id IN ('stjerome','stjeromesafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot St-Jérôme</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//St-Jérôme:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot St-Jérôme commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','st-jerome@entrepotdelalunette.com');
...
$subject      = "Rapport Importation Optipro St-Jérôme: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_stjerome'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/stjerome/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page)
 VALUES('Rapport importation Optipro St-Jerome 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_stjerome.php')"; 					
