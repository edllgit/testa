...
WHERE user_id IN ('moncton','monctonsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Moncton</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Moncton:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Moncton commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','moncton@entrepotdelalunette.com');



$curTime      = date("m-d-Y");	
$from_address = 'donotreply@entrepotdelalunette.com';
$subject      = "Rapport Importation Optipro Moncton: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_moncton'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/moncton/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Moncton 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_moncton.php')"  ; 					
