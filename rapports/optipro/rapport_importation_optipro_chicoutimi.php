<?php
//RAPPORT :Entrepot de Chicoutimi
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Chicoutimi</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//CHICOUTIMI:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Chicoutimi commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$to_address = array('rapports@direct-lens.com','chicoutimi@entrepotdelalunette.com');



$curTime      = date("m-d-Y");	
$from_address = 'donotreply@entrepotdelalunette.com';
$subject      = "Rapport Importation Optipro Chicoutimi: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_chicou'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier

		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/chicoutimi/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Chicoutimi 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_chicoutimi.php')"  ; 					
