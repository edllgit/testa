<?php
//RAPPORT :Entrepot de Fredericton
...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='1195542427918704'; // TODO: remplacer avec le code d'access pour fredericton
}elseif ($_REQUEST[access]=='1195542427918704'){ // TODO: remplacer avec le code d'access pour fredericton
...
WHERE user_id IN ('fredericton','frederictonsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Fredericton</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Fredericton:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Fredericton commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','fredericton@entrepotdelalunette.com');
...
$subject      = "Rapport Importation Optipro Fredericton: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_fredericton'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/Fredericton/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Fredericton 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_fredericton.php')"; 					
