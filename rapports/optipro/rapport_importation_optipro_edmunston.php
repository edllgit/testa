<?php
//RAPPORT :Entrepot de Edmundston
...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='954123684';
}elseif ($_REQUEST[access]=='954123684'){
...
WHERE user_id IN ('edmundston','edmundstonsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Edmundston</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Edmundston:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Edmundston commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','edmundston@entrepotdelalunette.com');



$curTime      = date("m-d-Y");	
$from_address = 'donotreply@entrepotdelalunette.com';
$subject      = "Rapport Importation Optipro Edmundston: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_edmundston'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/edmundston/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Edmundston 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_edmundston.php')"  ; 					
