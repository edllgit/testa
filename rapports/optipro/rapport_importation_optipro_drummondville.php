<?php
//RAPPORT :Entrepot de Drummondville
...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='6519872431';
}elseif ($_REQUEST[access]=='6519872431'){
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Drummondville</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//DRUMMONDVILLE:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Drummondville: Commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$message.="</table>";
$to_address = array('rapports@direct-lens.com','drummondville@entrepotdelalunette.com');
...
$subject      = "Rapport Importation Optipro Drummondville: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_drumond'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/drummondville/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro Drummondville 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_drummondville.php')"  ; 					
