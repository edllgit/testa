...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='1195542427918704'; // TODO: remplacer avec le code d'access pour stjohn
}elseif ($_REQUEST[access]=='1195542427918704'){ // TODO: remplacer avec le code d'access pour stjohn
...
WHERE user_id IN ('stjohn','stjohnsafe')
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot St-John</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_stjohn'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/stjohn/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) VALUES('Rapport importation Optipro St-John 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_stjohn.php')"; 					
