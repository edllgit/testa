<?php
//RAPPORT :Entrepot de Sherbrooke
...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='19873154875';
}elseif ($_REQUEST[access]=='19873154875'){
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th>Entrepot Sherbrooke</th></tr>
	<tr bgcolor=\"CCCCCC\">
...
//SHERBROOKE:   commandes cancellés car pas de coupon
...
if ($ordersnum1!=0){
	...
	$message.="<tr><th colspan=\"5\">Entrepot Sherbrooke commandes cancellées car pas de coupon valide n'a été appliqué</th></tr>
	<tr bgcolor=\"CCCCCC\">
		<td align=\"center\">Order Number</td>
		<td align=\"center\"># Optipro</td>
...
$subject      = "Rapport Importation Optipro Sherbrooke: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_sherbrooke'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/#Optipro/sherbrooke/' . $nomFichier . '.html';
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page)
 VALUES('Rapport importation Optipro Sherbrooke 2.0', '$time','$today','$timeplus3heures','rapport_importation_optipro_sherbrooke.php')"; 					
