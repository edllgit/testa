...
FROM orders, labs
WHERE orders.prescript_lab = labs.primary_key
AND user_id IN ('laval','lavalsafe')
...
$subject      = "Entrepot de le lunette Laval: commandes en cours";
...
//Log email
	...
	$nomFichier = 'r_commande_en_cours_laval'. $timestamp;

	// Enregistrez le contenu HTML dans un fichier
	$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/laval/' . $nomFichier . '.html';
...
VALUES ('Rapport commandes en cours Laval 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_laval.php') "  ; 					
