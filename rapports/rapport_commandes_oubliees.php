...
//$month = 'janvier'; // Remplacez par le mois que vous souhaitez utiliser
//$year = 2023;       // Remplacez par l'année que vous souhaitez utiliser


// Récupération du mois et de l'année courants
$currentMonthNumber = date("n"); // Numéro du mois (1 à 12)
$currentYear = date("Y"); // Année

// Tableau associatif pour convertir le numéro du mois en texte
$monthsArray = array(
    1 => 'janvier',
    2 => 'fevrier',
    3 => 'mars',
...
// Convertir le numéro du mois en texte
$currentMonthText = $monthsArray[$currentMonthNumber];

// Affichage des résultats
echo "Mois courant : $currentMonthText<br>";
echo "Année courante : $currentYear<br>";
...
echo "Date de début: $date1<br>";
echo "Date de fin: $date2";
...
echo '<br><strong>Mois</strong>: '. $month . ' ' . $year.'<br><br>';
	...
	for ($i =1; $i <= 4 ; $i++) {
		...
		echo '<br>Dates: '. $date1 . ' - ' . $date2;
			//WHERE $Userid	orders.user_id IN ('vaudreuil','vaudreuilsafe')
		$rptQuery="
	...
	$nomFichier = 'r_commandes_oubliees_'.$Partie. $timestamp;
