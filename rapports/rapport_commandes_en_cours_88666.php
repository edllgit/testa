...
echo '<br>nomobre de commandes: '.$ordersnum;	
if (($ordersnum<>0) || ($ordersnum == 0)){
...
$subject      = "Griffé #88666: $ordersnum Commandes en cours";
...
//Log email
	...
	$nomFichier = 'r_commande_en_cours_Griffe'. $timestamp;

	// Enregistrez le contenu HTML dans un fichier
	$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/Griffe/' . $nomFichier . '.html';
