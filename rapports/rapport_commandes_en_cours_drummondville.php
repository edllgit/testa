...
$subject      = "Entrepot de le lunette Drummondville: commandes en cours";
echo 'Object : '.$subject;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_en_cours_drumon'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/drummondville/' . $nomFichier . '.html';
...
VALUES('Entrepot lunette Vaudreuil Orders In production 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_drummondville.php')"; 					
