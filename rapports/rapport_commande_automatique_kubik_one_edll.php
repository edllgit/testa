...
$send_to_address = array('rapports@direct-lens.com','sophia@superb-vision.com','riazzolino@opticalvisiongroup.com','monture@entrepotdelalunette.com','approvisionnement@entrepotdelalunette.com');
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_Kubik_one_'. $timestamp;
