...
//A RECOMMENTER
/*
$Ilya6jours = '2022-01-12';
$aujourdhui = '2022-01-18';
*/
...
$CollectionsAEvaluer =" AND supplier IN ('LAPO','ELEVENPARIS','OWLET')";
...
//SEND EMAIL
	...
	//
$send_to_address = array('rapports@direct-lens.com','monture@entrepotdelalunette.com','approvisionnement@entrepotdelalunette.com','alemoy@opal-canada.ca');
...
$subject="LAPO EDLL Frames order(s) Between $Ilya6jours and $aujourdhui";
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_lapo'. $timestamp;
