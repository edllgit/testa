...
FROM orders, labs
WHERE orders.prescript_lab = labs.primary_key
AND user_id IN ('terrebonne','terrebonnesafe')
...
$subject      = "Entrepot de la lunette Terrebonne: commandes en cours";
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_commande_en_cours_terrebonne'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/terrebonne/' . $nomFichier . '.html';
...
VALUES('Rapport commandes en cours Terrebonne 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_terrebonne.php')"; 					
