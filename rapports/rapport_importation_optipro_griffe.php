...
if (isset($_REQUEST[access])==false){	
	$_REQUEST[access]='1195542427918704'; // TODO: remplacer avec le code d'access pour Griffe
}elseif ($_REQUEST[access]=='1195542427918704'){ // TODO: remplacer avec le code d'access pour Griffe
...
//Griffé:   commandes cancellés car pas de coupon
...
$subject      = "Rapport Importation Optipro Griffe: ".$today;
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_import_optipro_Griffe'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/importation/Griffe/' . $nomFichier . '.html';
