...
$subject      = "Redo Interne Entrepot de le lunette Drummondville: $date1-$date2";
//SEND EMAIL
	if ($SendEmail == 'yes'){
...
//Log email
	...
	foreach($to_address as $key => $value)
	{
		...
		$nomFichier = 'r_reprise_interne_semaine_drummondville'. $timestamp;
	
		// Enregistrez le contenu HTML dans un fichier
		$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/REPRISE/Semaine/drummondville/' . $nomFichier . '.html';
