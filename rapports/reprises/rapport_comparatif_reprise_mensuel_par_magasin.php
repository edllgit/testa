...
switch($i){
	...
	case 21: $Userid =  " orders.user_id IN ('dartmouth','dartmouthsafe')";    		$Compagnie = 'Dartmouth';		$Succ = 'Dartmouth'; 		
	$send_to_address = array('rapports@direct-lens.com'); 			ob_start(); 	break;
...
$message.="</thead>";
	...
	$nomFichier = 'r_comparatif_reprise_mensuel_par_magasin_'.$Succ. $timestamp;

	// Enregistrez le contenu HTML dans un fichier
	$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/REPRISE/Mensuel/#Reprise_Mensuel_par_Magasin/' . $nomFichier . '.html';
