...
if ($_REQUEST[debug]=='yes'){
	...
	$rptQuery  = "SELECT accounts.user_id as user_id, accounts.account_num, accounts.company, labs.lab_name, orders.order_num as   order_num, orders.po_num, orders.order_total, 
	orders.order_date_processed, orders.order_date_shipped,  orders.redo_order_num, orders.order_patient_first,orders.order_product_name, orders.order_patient_last, orders.tray_num, 
...
if ($ordersnum!=0){
	...
	$subject      = "Redos of the day - Swiss: $today ";
	...
	$nomFichier = 'r_reprise_swiss_'. $timestamp;
...
$CronQuery       = "INSERT INTO cron_duration(cron_script_name,cron_duration, cron_date, cron_time,php_page) 
					VALUES('Rapport reprises Swiss 2.0', '$time','$today','$heure_execution','rapport_reprise_swiss.php')"; 					
