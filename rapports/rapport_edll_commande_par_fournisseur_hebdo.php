...
/*$aujourdhui = time();  // Obtient la timestamp actuelle (en secondes depuis l'époque)
$tem = strtotime("-7 days", $aujourdhui);  // Soustrait 7 jours à la date actuelle
$JourDebut = date("Y/m/d", $tem);  // Formate la nouvelle date

echo "Jour de début : " . $JourDebut;*/
...
echo '<br><br>'. $message;
	...
	$nomFichier = 'r_commande_par_fournisseur_hebdo_'. $Succ. $timestamp;
