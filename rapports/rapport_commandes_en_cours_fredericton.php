...
//Log email
	...
	$nomFichier = 'r_commande_en_cours_Frede'. $timestamp;

	// Enregistrez le contenu HTML dans un fichier
	$cheminFichierHtml = 'C:/All_Rapports_EDLL/general/Commande/en_cours/Fredericton/' . $nomFichier . '.html';
...
VALUES('Entrepot lunette Fredericton Orders In production 2.0', '$time','$today','$timeplus3heures','rapport_commandes_en_cours_Fredericton.php')"; 					
