...
var number23 = document.getElementById('top_urgent');
selectItemByValue(number23, "regular");
...
function validateFastOrder(theForm){
	//Validate the reference
	if((theForm.LAST_NAME.value=="")&&(theForm.FIRST_NAME.value=="")){//FIRST AND LAST NAME
		alert("<?php echo 'Either the Patient First or the Last Name must be filled';?>");
		theForm.FIRST_NAME.focus();
		return (false);
	}
	
	
	//Validate the spheres
	if ((theForm.EYE.value=='Both') || (theForm.EYE.value=='R.E.'))
	{
		if (theForm.RE_SPH.value=='')
	  {
		alert("<?php echo 'Right sphere is mandatory.';?>");
		theForm.RE_SPH.focus();
		return (false);
	  }
	}
	
	if  ((theForm.RE_SPH.value > 10) || (theForm.RE_SPH.value < -10))
	{
		alert("<?php echo 'Higher than -10/+10, please contact your Lab.';?>");
		theForm.RE_SPH.focus();
		return (false);
	}
	
	
	if ((theForm.EYE.value=='Both') || (theForm.EYE.value=='L.E.'))
	{
		if (theForm.LE_SPH.value=='')
	  {
		alert("<?php echo 'Left sphere is mandatory.';?>");
		theForm.LE_SPH.focus();
		return (false);
	  }
	}
	
	
	if  ((theForm.LE_SPH.value > 10) || (theForm.LE_SPH.value < -10))
	{
		alert("<?php echo 'Higher than -10/+10, please contact your Lab.';?>");
		theForm.LE_SPH.focus();
		return (false);
	...
	//Validate the Cylinders
	if ((theForm.EYE.value=='R.E.') || (theForm.EYE.value=='Both'))
	{	
		if ((theForm.RE_AXIS.value =="")&&(theForm.RE_CYL.value!=""))
		  {
			alert("<?php echo 'Please enter a value for the RE Axis.';?>");
			theForm.RE_AXIS.focus();
			return (false);
		  }
	}
	
	if ((theForm.EYE.value=='L.E.') || (theForm.EYE.value=='Both'))
	{	
		if ((theForm.LE_AXIS.value =="")&&(theForm.LE_CYL.value!=""))
		  {
			alert("<?php echo 'Please enter a value for the LE Axis.';?>");
			theForm.LE_AXIS.focus();
			return (false);
		  }
	}
	...
	{	
		if ((theForm.RE_AXIS.value !="")&&(theForm.RE_CYL.value==""))
		  {
			alert("<?php echo 'Please enter a value for the RE Cylinder.';?>");
			theForm.RE_CYL.focus();
			return (false);
		  }
	}
	...
	{	
		if ((theForm.LE_AXIS.value !="")&&(theForm.LE_CYL.value==""))
		  {
			alert("<?php echo 'Please enter a value for the LE Cylinder.';?>");
			theForm.LE_CYL.focus();
			return (false);
		  }
	}
	...
	//Validate additions and Fitting heights
	if ((theForm.EYE.value=='R.E.') || (theForm.EYE.value=='Both'))
	{
		if ((theForm.RE_HEIGHT.value=="")&&(theForm.RE_ADD.value!=""))
		{
		   alert("<?php echo $lbl_alert19_pl;?>");
		   theForm.RE_HEIGHT.focus();
		   return (false);
	...
	if ((theForm.EYE.value=='L.E.') || (theForm.EYE.value=='Both'))
	{
		if ((theForm.LE_HEIGHT.value=="")&&(theForm.LE_ADD.value!=""))
		{
		  alert("<?php echo $lbl_alert20_pl;?>");
		  theForm.LE_HEIGHT.focus();
		  return (false);
	...
	if((theForm.TINT.value=="Gradient")&&(theForm.TINT_COLOR.value=="")){//Gradient TINT
		alert("<?php echo 'Please select a color for your tint';?>");
	    theForm.TINT_COLOR.focus();
		return (false);
	}
	
	if((theForm.TINT.value=="Solid")&&(theForm.TINT_COLOR.value=="")){//Gradient TINT
		alert("<?php echo 'Please select a color for your tint';?>");
	    theForm.TINT_COLOR.focus();
		return (false);
	}
	
	//Validate frame measurements
	if ((theForm.FRAME_A.value> 66)||(theForm.FRAME_A.value<35))
	{
	  alert("<?php echo 'The value of Frame A must be between 35 AND 66';?>");
	  theForm.FRAME_A.focus();
	...
	//Validate edge and mount fields
	if((theForm.JOB_TYPE.value=="Edge and Mount")&&(theForm.SUPPLIER.value=="")){
	 alert("<?php echo $lbl_alert3_pl;?>");
	 theForm.SUPPLIER.focus();
	 return (false);
	...
	//Validate selected Lens
	if (theForm.selected_lens.value== "0")
	{
	  alert("<?php echo 'Please select a lens';?>");
	  theForm.selected_lens.focus();
	  return (false);
	}
