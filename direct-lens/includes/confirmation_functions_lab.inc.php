...
function sendStockConfirmationLab($fromAddress,$logo_file,$orderNum,$send_to_address,$user_id){//STOCK BULK AND TRAY CONFIRMATION
	...
	elseif ($listItem['product_line']=="ifcclub")
		{$dl_logo_file= constant('DIRECT_LENS_URL')."/direct-lens/logos/ifc_club_logo.gif";
		$pl_text="IFC Club";}
	else
...
$message.='<table width="650" border="0"cellpadding="3" cellspacing="0" align="center"><tr><td align="left"><img src="'.constant('DIRECT_LENS_URL').'/direct-lens/logos/'.$logo_file.'"/><td align="center"><img src="'.$dl_logo_file.'" width="200" height="60" /></td></td><td align="right"><img src="'.$barcode.'" width="190" height="50" /></td></tr></table>';//ABSOLUTE PATH TO THE BARCODE IMAGE
...
//New SES email code
$to_address = 'dbeaulieu@direct-lens.com';
$from_address='donotreply@entrepotdelalunette.com';
$response=office365_mail($to_address, $from_address, $subject, null, $message);
}

function sendPrescriptionConfirmationLab($fromAddress,$logo_file,$orderNum,$send_to_address,$user_id,$sendPrices){//PRESCRIPTION CONFIRMATION
	include "../sec_connectEDLL.inc.php";
...
$message.='<table width="650" border="0"cellpadding="3" cellspacing="0" align="center"><tr><td align="left"><img src="http://www.direct-lens.com/direct-lens/logos/'.$logo_file.'"/><td align="center"><img src="'.$dl_logo_file.'" width="200" height="60" /></td></td><td align="right"><img src="'.$barcode.'" width="190" height="50" /></td></tr></table>';//ABSOLUTE PATH TO THE BARCODE IMAGE
