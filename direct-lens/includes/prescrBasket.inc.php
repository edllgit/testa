...
$resultSelectedPromo = mysqli_query($con,$querySelectedPromo) or die  ('I cannot select items because 11: ' . mysqli_error($con));
...
if (($DataSelectedPromo[selected_promotion]=='sizzling summer')   && ($DebutNomProduit <>'Promo')) {
	...
	$resultLensCategory  = mysqli_query($con,$queryLensCategory) or die  ('I cannot select items because 12: ' . mysqli_error($con));
